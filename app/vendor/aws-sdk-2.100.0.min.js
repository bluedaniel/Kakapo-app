(_xamzrequire = (function e(t, r, n) {
  ...
  for (
    var o = 'function' == typeof _xamzrequire && _xamzrequire, s = 0;
    s < n.length;
    s++
  )
    i(n[s]);
...
})(
  {
    194: [
      function(e, t, r) {
        ...
        }), e('./service'), e('./config'), e('./http'), e(
          './sequential_executor'
        ), e('./event_listeners'), e('./request'), e('./response'), e(
          './resource_waiter'
        ), e('./signers/request_signer'), e(
          './param_validator'
      ...
      function(e, t, r) {
        ...
        function c(e, t) {
          ...
          t.xmlNamespaceUri
            ...
            : e.isRoot &&
              t.api.xmlNamespaceUri &&
              (r = t.api.xmlNamespaceUri), r && e.att(n, r);
        }
        var l = e('../util'),
          h = e('xmlbuilder');
        (n.prototype.toXML = function(e, t, r, n) {
          var o = h.create(r);
          return c(o, t), i(o, e, t), o.children.length > 0 || n
            ? o.root().toString()
            : '';
        }), (t.exports = n);
      },
      { '../util': 261, xmlbuilder: 187 }
    ],
    253: [
      function(e, t, r) {
        var n = e('../core'),
        ...
        }), e('./v2'), e('./v3'), e('./v3https'), e('./v4'), e('./s3'), e(
          './presign'
        );
      },
      {
      ...
      function(e, t, r) {
        ...
        (n.Signers.V4 = o(n.Signers.RequestSigner, {
          constructor: function(e, t, r) {
            n.Signers.RequestSigner.call(this, e), (this.serviceName = t), (r =
              r || {}), (this.signatureCache =
              'boolean' != typeof r.signatureCache ||
              r.signatureCache), (this.operation = r.operation);
          },
          ...
          addHeaders: function(e, t) {
            (this.request.headers['X-Amz-Date'] = t), e.sessionToken &&
          ...
          updateForPresigned: function(e, t) {
            ...
            e.sessionToken && (i['X-Amz-Security-Token'] = e.sessionToken), this
              .request.headers['Content-Type'] &&
              (i['Content-Type'] = this.request.headers['Content-Type']), this
              .request.headers['Content-MD5'] &&
              (i['Content-MD5'] = this.request.headers['Content-MD5']), this
              .request.headers['Cache-Control'] &&
              (i['Cache-Control'] = this.request.headers[
                'Cache-Control'
          ...
          authorization: function(e, t) {
            ...
            return r.push(
              this.algorithm + ' Credential=' + e.accessKeyId + '/' + n
            ), r.push('SignedHeaders=' + this.signedHeaders()), r.push(
              'Signature=' + this.signature(e, t)
            ), r.join(', ');
          },
          ...
          stringToSign: function(e) {
            var t = [];
            return t.push('AWS4-HMAC-SHA256'), t.push(e), t.push(
              this.credentialString(e)
            ), t.push(this.hexEncodedHash(this.canonicalString())), t.join(
              '\n'
            );
          },
          canonicalString: function() {
            ...
            return 's3' !== this.serviceName &&
              (t = n.util.uriEscapePath(t)), e.push(
              this.request.method
            ), e.push(t), e.push(this.request.search()), e.push(
              this.canonicalHeaders() + '\n'
            ), e.push(this.signedHeaders()), e.push(
            ...
            return n.util.arrayEach.call(this, e, function(e) {
              ...
              if (this.isSignableHeader(r)) {
                ...
                if (
                  ...
                  throw n.util.error(
                    new Error('Header ' + r + ' contains invalid value'),
                    { code: 'InvalidHeader' }
                  );
      ...
      function(e, t, r) {
        ...
        t.exports = {
          ...
          getSigningKey: function(e, t, r, s, a) {
            ...
            return a &&
              ((i[c] = p), o.push(c), o.length > 50 && delete i[o.shift()]), p;
          },
          emptyCache: function() {
            (i = {}), (o = []);
          }
      ...
      function(e, t, r) {
        ...
        (n.Signers.V3 = i(n.Signers.RequestSigner, {
          addAuthorization: function(e, t) {
            ...
            (this.request.headers['X-Amz-Date'] = r), e.sessionToken &&
              (this.request.headers['x-amz-security-token'] =
                e.sessionToken), (this.request.headers[
          ...
          stringToSign: function() {
            var e = [];
            return e.push(this.request.method), e.push('/'), e.push(''), e.push(
              this.canonicalHeaders()
      ...
      function(e, t, r) {
        ...
        (n.Signers.V2 = i(n.Signers.RequestSigner, {
          addAuthorization: function(e, t) {
            ...
            var r = this.request;
            (r.params.Timestamp = n.util.date.iso8601(
              t
            )), (r.params.SignatureVersion = '2'), (r.params.SignatureMethod =
              'HmacSHA256'), (r.params.AWSAccessKeyId =
              e.accessKeyId), e.sessionToken &&
              (r.params.SecurityToken = e.sessionToken), delete r.params
              .Signature, (r.params.Signature = this.signature(
              e
            )), (r.body = n.util.queryParamsToString(r.params)), (r.headers[
              'Content-Length'
            ] =
              r.body.length);
          },
          ...
          stringToSign: function() {
            var e = [];
            return e.push(this.request.method), e.push(
              this.request.endpoint.host.toLowerCase()
            ), e.push(this.request.pathname()), e.push(
              n.util.queryParamsToString(this.request.params)
            ), e.join('\n');
          }
        ...
        (n.Signers.S3 = i(n.Signers.RequestSigner, {
          ...
          addAuthorization: function(e, t) {
            this.request.headers['presigned-expires'] ||
              (this.request.headers['X-Amz-Date'] = n.util.date.rfc822(
                t
              )), e.sessionToken &&
              (this.request.headers['x-amz-security-token'] = e.sessionToken);
          ...
          stringToSign: function() {
            var e = this.request,
              t = [];
            t.push(e.method), t.push(e.headers['Content-MD5'] || ''), t.push(
          ...
          canonicalizedResource: function() {
            ...
            if (
              (
                e.virtualHostedBucket && (o += '/' + e.virtualHostedBucket),
                (o += r),
                i
              )
            ) {
              ...
              n.util.arrayEach.call(this, i.split('&'), function(e) {
                ...
                if (this.subResources[t] || this.responseHeaders[t]) {
                  ...
                  void 0 !== r &&
                    (this.subResources[t]
                      ? (n.value = r)
                      : (n.value = decodeURIComponent(r))), s.push(n);
                }
              }), s.sort(function(e, t) {
      ...
      function(e, t, r) {
        ...
        function i(e) {
          var t = e.httpRequest.endpoint,
            ...
            n = {};
          r.search &&
            (n = o.util.queryStringParse(r.search.substr(1))), o.util.each(
            e.httpRequest.headers,
            function(e, t) {
              e === a && (e = 'Expires'), 0 === e.indexOf('x-amz-meta-') &&
                (delete n[e], (e = e.toLowerCase())), (n[e] = t);
            }
          ), delete e.httpRequest.headers[a];
          var i = n.Authorization.split(' ');
          if ('AWS' === i[0])
            (i = i[1].split(':')), (n.AWSAccessKeyId = i[0]), (n.Signature =
              i[1]);
          ...
          delete n.Authorization, delete n.Host, (t.pathname =
            r.pathname), (t.search = o.util.queryParamsToString(n));
        }
        var o = e('../core'),
          s = o.util.inherit,
          a = 'presigned-expires';
    ...
    234: [
      function(e, t, r) {
        ...
        (n.Service = s({
          ...
          initialize: function(e) {
            ...
            (this.config = new n.Config(n.config)), t &&
              this.config.update(t, !0), e &&
              this.config.update(e, !0), this.validateService(), this.config
              .endpoint ||
              o(this), (this.config.endpoint = this.endpointFromTemplate(
          ...
          getLatestServiceClass: function(e) {
            return (e = this.getLatestServiceVersion(e)), null ===
              this.constructor.services[e] &&
              n.Service.defineServiceApi(this.constructor, e), this.constructor
              .services[e];
          },
          ...
          addAllRequestListeners: function(e) {
            ...
            this.config.paramValidation ||
              ...
              e.addListeners(
                n.EventListeners.Logger
              ), this.setupRequestListeners(e), 'function' ==
              typeof this.constructor.prototype.customRequestHandler &&
              this.constructor.prototype.customRequestHandler(
                e
          ...
          getSignerClass: function(e) {
            ...
            if (e) {
              (r =
                (e.service.api.operations || {})[e.operation] || null), (i = r
                ? r.authtype
                : '');
            }
            return (t = this.config.signatureVersion
              ? this.config.signatureVersion
              : 'v4' === i || 'v4-unsigned-body' === i
                ? 'v4'
                : this.api
                    .signatureVersion), n.Signers.RequestSigner.getVersion(t);
          },
          ...
          defineService: function(e, t, r) {
            (n.Service._serviceMap[e] = !0), Array.isArray(t) ||
              ((r = t), (t = []));
            var i = s(n.Service, r || {});
            if ('string' == typeof e) {
          ...
          defineServiceApi: function(e, t, r) {
            ...
            if ('string' == typeof t) {
              ...
              Object.prototype.hasOwnProperty.call(e.services, t) ||
                (e.apiVersions = e.apiVersions.concat(t).sort()), (e.services[
                t
              ] = a);
            } else o(t);
      ...
      { './core': 194, './model/api': 212, './region_config': 227 }
    ],
    227: [
      function(e, t, r) {
        function n(e) {
        ...
        function s(e) {
          for (var t = i(e), r = 0; r < t.length; r++) {
            ...
            if (n && Object.prototype.hasOwnProperty.call(u.rules, n)) {
              var s = u.rules[n];
              return 'string' == typeof s && (s = u.patterns[s]), e.config
                .useDualstack &&
                a.isDualstackAvailable(e) &&
                (
                  (s = a.copy(s)),
                  (s.endpoint = '{service}.dualstack.{region}.amazonaws.com')
                ), (e.isGlobalEndpoint = !!s.globalEndpoint), s.signatureVersion ||
                (s.signatureVersion = 'v4'), void o(e, s);
            }
          }
        }
        var a = e('./util'),
      ...
      { './region_config_data.json': 228, './util': 261 }
    ],
    228: [
      function(e, t, r) {
        t.exports = {
    ...
    231: [
      function(e, t, r) {
        ...
        n.Response = i({
          constructor: function(e) {
            (this.request = e), (this.data = null), (this.error = null), (this.retryCount = 0), (this.redirectCount = 0), (this.httpResponse = new n.HttpResponse()), e &&
              (
          ...
          hasNextPage: function() {
            return this.cacheNextPageTokens(), !!this.nextPageTokens ||
          ...
          cacheNextPageTokens: function() {
            ...
            return 'string' == typeof t &&
              (t = [t]), n.util.arrayEach.call(this, t, function(e) {
    ...
    230: [
      function(e, t, r) {
        function n(e) {
          ...
          }), !n && e.error && (i = 'failure'), 'success' === i
            ? t.setSuccess(e)
            : t.setError(e, 'retry' === i);
        }
        var i = e('./core'),
          o = i.util.inherit,
          s = e('jmespath');
        i.ResourceWaiter = o({
          constructor: function(e, t) {
            (this.service = e), (this.state = t), this.loadWaiterConfig(
              this.state
            );
          },
          service: null,
          ...
          wait: function(e, t) {
            'function' == typeof e && ((t = e), (e = void 0)), e &&
              e.$waiter &&
              (
                (e = i.util.copy(e)),
                'number' == typeof e.$waiter.delay &&
            ...
            return (r._waiter = this), (r.response.maxRetries = this.config.maxAttempts), r.addListeners(
              this.listeners
            ), t && r.send(t), r;
          },
          setSuccess: function(e) {
            (e.error = null), (e.data =
              e.data || {}), e.request.removeAllListeners('extractData');
          },
      ...
      function(e, t, r) {
        (function(t) {
          ...
          (c.setupStates = function() {
            var e = function(e, t) {
              var n = this;
              (n._haltHandlersOnError = !1), n.emit(
                n._asm.currentState,
                function(e) {
                  if (e)
                    if (r(n)) {
                      if (!(s && n.domain instanceof s.Domain)) throw e;
                      (e.domainEmitter = n), (e.domain =
                        n.domain), (e.domainThrown = !1), n.domain.emit(
                        'error',
                        e
                      );
            ...
            this.addState('validate', 'build', 'error', e), this.addState(
              'build',
              'afterBuild',
              'restart',
              e
            ), this.addState('afterBuild', 'sign', 'restart', e), this.addState(
              'sign',
              'send',
              'retry',
              e
              ...
              'afterRetry',
              e
            ), this.addState('afterRetry', 'sign', 'error', e), this.addState(
              'send',
              'validateResponse',
              'retry',
              e
              ...
              'retry',
              e
            ), this.addState('restart', 'build', 'error', e), this.addState(
              'success',
              'complete',
              'complete',
              e
            ), this.addState('error', 'complete', 'complete', e), this.addState(
              'complete',
              null,
              null,
              e
            ...
            constructor: function(e, t, r) {
              ...
              e.isGlobalEndpoint && (a = 'us-east-1'), (this.domain =
                s &&
                s.active), (this.service = e), (this.operation = t), (this.params =
                r || {}), (this.httpRequest = new n.HttpRequest(
                o,
                a
              )), this.httpRequest.appendToUserAgent(
                u
              ), (this.startTime = n.util.date.getDate()), (this.response = new n.Response(
                this
              )), (this._asm = new i(
                c.states,
                'validate'
              )), (this._haltHandlersOnError = !1), n.SequentialExecutor.call(
                this
            ...
            createReadStream: function() {
              var e = n.util.stream,
                r = this,
                i = null;
              return 2 === n.HttpClient.streamsApiVersion
                ? (
                    (i = new e.PassThrough()),
                    t.nextTick(function() {
                      r.send();
                  ...
                  if (2 === n.HttpClient.streamsApiVersion)
                    if (u) {
                      ...
                      (f._write = function(t) {
                        return t &&
                          t.length &&
                          (c += t.length), e.PassThrough.prototype._write.apply(
                          this,
                          arguments
                        );
                      }), f.on('end', l), i.on('error', function(e) {
                        (u = !1), h.unpipe(f), f.emit('end'), f.end();
                      }), h.pipe(f).pipe(i, { end: !1 });
                    } else h.pipe(i);
                  else
                    u &&
            ...
            emitEvent: function(e, t, r) {
              'function' == typeof t && ((r = t), (t = null)), r ||
                (r = function() {}), t ||
                (t = this.eventParameters(
                  e,
                  this.response
                )), n.SequentialExecutor.prototype.emit.call(
                this,
                e,
                t,
                function(e) {
            ...
            presign: function(e, t) {
              return t || 'function' != typeof e || ((t = e), (e = null)), new n
                .Signers.Presign().sign(this.toGet(), e, t);
            },
            isPresigned: function() {
              return Object.prototype.hasOwnProperty.call(
            ...
            toUnauthenticated: function() {
              ...
              ), this.removeListener('sign', n.EventListeners.Core.SIGN), this;
            },
            toGet: function() {
              return ('query' !== this.service.api.protocol &&
            ...
            buildAsGet: function(e) {
              (e.httpRequest.method = 'GET'), (e.httpRequest.path =
                e.service.endpoint.path +
                '?' +
                e.httpRequest.body), (e.httpRequest.body = ''), delete e
                .httpRequest.headers['Content-Length'], delete e.httpRequest
            ...
            this.prototype.promise = function() {
              var t = this;
              return this.httpRequest.appendToUserAgent(
                'promise'
              ), new e(function(e, r) {
          ...
          }), n.util.addPromises(n.Request), n.util.mixin(
            n.Request,
            n.SequentialExecutor
          );
        }.call(this, e('_process')));
      },
      { './core': 194, './state_machine': 260, _process: 154, jmespath: 13 }
    ],
    260: [
      function(e, t, r) {
        function n(e, t) {
        ...
        (n.prototype.runTo = function(e, t, r, n) {
          ...
          return 'function' == typeof t
            ? ((n = t), (t = null), (r = null))
            : 'function' == typeof r && ((n = r), (r = null)), this
            .currentState || (this.currentState = e), (this.states[e] = {
            accept: t,
            fail: r,
            fn: n
          }), this;
      ...
      function(e, t, r) {
        ...
        n.ParamValidator = n.util.inherit({
          ...
          validateString: function(e, t, r) {
            var n = ['string'];
            e.isJsonValue &&
              (n = n.concat(['number', 'object', 'boolean'])), null !== t &&
    ...
    212: [
      function(e, t, r) {
        function n(e, t) {
          (e = e || {}), (t = t || {}), (t.api = this), (e.metadata =
            e.metadata || {}), l(this, 'isApi', !0, !1), l(
            this,
            'apiVersion',
            e.metadata.apiVersion
          ), l(this, 'endpointPrefix', e.metadata.endpointPrefix), l(
            this,
            'signingName',
            e.metadata.signingName
          ), l(this, 'globalEndpoint', e.metadata.globalEndpoint), l(
            this,
            'signatureVersion',
            e.metadata.signatureVersion
          ), l(this, 'jsonVersion', e.metadata.jsonVersion), l(
            this,
            'targetPrefix',
            e.metadata.targetPrefix
          ), l(this, 'protocol', e.metadata.protocol), l(
            this,
            'timestampFormat',
            e.metadata.timestampFormat
          ), l(this, 'xmlNamespaceUri', e.metadata.xmlNamespace), l(
            this,
            'abbreviation',
            e.metadata.serviceAbbreviation
          ), l(
            this,
            'fullName',
            e.metadata.serviceFullName
            ...
            (
              l(this, 'documentation', e.documentation),
              l(this, 'documentationUrl', e.documentationUrl)
            );
        }
        var i = e('./collection'),
          o = e('./operation'),
      ...
      function(e, t, r) {
        function n(e, t, r) {
          (r = r || {}), o(this, 'name', e), o(
            ...
            o(this, 'operation', i.string.lowerFirst(t.operation));
          var n = this;
          [
            'type',
            'description',
    ...
    215: [
      function(e, t, r) {
        function n(e, t) {
          i(this, 'inputToken', t.input_token), i(
            this,
            'limitKey',
            t.limit_key
          ), i(this, 'moreResults', t.more_results), i(
            this,
            'outputToken',
            t.output_token
      ...
      function(e, t, r) {
        function n(e, t, r) {
          ...
          (r = r || {}), s(this, 'name', t.name || e), s(
            ...
            'httpMethod',
            t.http.method || 'POST'
          ), s(this, 'httpPath', t.http.requestUri || '/'), s(
            this,
            'authtype',
            t.authtype || ''
            ...
            (
              s(this, 'documentation', t.documentation),
              s(this, 'documentationUrl', t.documentationUrl)
      ...
      function(e, t, r) {
        ...
        (n.Endpoint = i({
          constructor: function(e, t) {
            ...
            n.util.update(this, n.util.urlParse(e)), this.port
              ? (this.port = parseInt(this.port, 10))
              : (this.port = 'https:' === this.protocol ? 443 : 80);
          }
        })), (n.HttpRequest = i({
          constructor: function(e, t) {
            (e = new n.Endpoint(e)), (this.method = 'POST'), (this.path =
              e.path || '/'), (this.headers = {}), (this.body =
              ''), (this.endpoint = e), (this.region = t), (this._userAgent =
              ''), this.setUserAgent();
          },
          ...
          appendToUserAgent: function(e) {
            'string' == typeof e &&
              e &&
              (this._userAgent += ' ' + e), (this.headers[
              this.getUserAgentHeaderName()
            ] = this._userAgent);
          },
          ...
          return void 0 === this.singleton &&
            (this.singleton = new this()), this.singleton;
        });
      },
      { './core': 194 }
    ],
    207: [
      function(e, t, r) {
        ...
        (i.EventListeners = { Core: {} }), (i.EventListeners = {
            ...
            t('VALIDATE_CREDENTIALS', 'validate', function(e, t) {
              ...
              if (e.service.api.operations) {
                ...
                if (t) {
                  ...
                  if (r.length) {
                    for (
                      var n = i.util.copy(e.params), o = 0, s = r.length;
                      o < s;
                      o++
                    )
              ...
              if ((e.haltHandlersOnError(), e.service.api.operations)) {
                ...
                if (e.service.getSignerClass(e) === i.Signers.V4) {
                  ...
                  if (n.indexOf('unsigned-body') >= 0)
                    return (e.httpRequest.headers['X-Amz-Content-Sha256'] =
                      'UNSIGNED-PAYLOAD'), t();
              ...
              var t = n(e);
              if (
                void 0 === e.httpRequest.headers['Content-Length'] &&
                -1 === t.indexOf('unsigned-body')
              ) {
              ...
              r.config.getCredentials(function(n, s) {
                ...
                try {
                  var a = i.util.date.getDate(),
                    ...
                    c = new u(
                      e.httpRequest,
                      r.api.signingName || r.api.endpointPrefix,
                      { signatureCache: r.config.signatureCache, operation: o }
                    );
                  c.setServiceClientId(
                    r._clientId
                  ), delete e.httpRequest.headers.Authorization, delete e.httpRequest.headers.Date, delete e.httpRequest.headers['X-Amz-Date'], c.addAuthorization(s, a), (e.signedAt = a);
                } catch (t) {
                  e.response.error = t;
                }
                t();
              ...
              function r(r) {
                ...
                r.on('headers', function(t, n, o) {
                  e.request.emit('httpHeaders', [t, n, e, o]), e.httpResponse
                    .streaming ||
                    (2 === i.HttpClient.streamsApiVersion
              ...
              function o(r) {
                if ('RequestAbortedError' !== r.code) {
                  var n =
                    'TimeoutError' === r.code ? r.code : 'NetworkingError';
                  r = i.util.error(r, {
                    code: n,
              ...
              (e.httpResponse._abortCallback = t), (e.error = null), (e.data = null), (i.util.date.getDate() -
                this.signedAt) /
                1e3 >=
              600
              ...
              if (o) {
                ...
                r.request.service.config.correctClockSkew &&
                  i.util.isClockSkewed(s) &&
                  i.util.applyClockOffset(s);
              }
              ...
              e.error &&
                ...
                (
                  (this.httpRequest.endpoint = new i.Endpoint(
                    e.httpResponse.headers.location
                  )),
              ...
              e.error &&
                (e.error.redirect && e.redirectCount < e.maxRedirects
                  ...
                  : e.retryCount < e.maxRetries &&
                    (e.error.retryDelay =
                      this.service.retryDelays(e.retryCount) || 0));
          ...
          CorePost: new o().addNamedListeners(function(e) {
            e(
              'EXTRACT_REQUEST_ID',
              'extractData',
              i.util.extractRequestId
            ), e('EXTRACT_REQUEST_ID', 'extractError', i.util.extractRequestId), e('ENOTFOUND_ERROR', 'httpError', function(e) {
              ...
              if (n) {
                var o = (function() {
                  var o = i.util.date.getDate().getTime(),
                    ...
                    l = '';
                  return a && (l += '[33m'), (l +=
                    '[AWS ' + r.service.serviceIdentifier + ' ' + u), (l +=
                    ' ' +
                    s.toString() +
                    's ' +
                    t.retryCount +
                    ' retries]'), a && (l += '[0;1m'), (l +=
                    ' ' + i.util.string.lowerFirst(r.operation)), (l +=
                    '(' + c + ')'), a && (l += '[0m'), l;
                })();
                'function' == typeof n.log
                  ? n.log(o)
                  : 'function' == typeof n.write && n.write(o + '\n');
              }
            });
          }),
          Json: new o().addNamedListeners(function(t) {
            ...
            t(
              ...
              'build',
              r.buildRequest
            ), t('EXTRACT_DATA', 'extractData', r.extractData), t('EXTRACT_ERROR', 'extractError', r.extractError);
          }),
        ...
        (n.SequentialExecutor = n.util.inherit({
          ...
          addListeners: function(e) {
            ...
            return e._events && (e = e._events), n.util.each(e, function(e, r) {
              'function' == typeof r && (r = [r]), n.util.arrayEach(r, function(
                r
              ) {
                t.on(e, r);
              });
          ...
          n.SequentialExecutor.prototype.on), (t.exports =
          n.SequentialExecutor);
      },
      { './core': 194 }
    ],
    224: [
      function(e, t, r) {
        ...
        function i(e) {
          c.buildRequest(e), ['GET', 'HEAD'].indexOf(e.httpRequest.method) <
            0 && n(e);
        }
        function o(e) {
          c.extractError(e);
          ...
          t.Errors && (t = t.Errors), t.Error && (t = t.Error), t.Code
      ...
      function(e, t, r) {
        ...
        function i(e) {
          e.httpRequest.headers['Content-Type'] ||
            (e.httpRequest.headers['Content-Type'] = 'application/json');
        }
        function o(e) {
          c.buildRequest(e), ['GET', 'HEAD', 'DELETE'].indexOf(
        ...
        function a(e) {
          ...
          if (r.payload) {
            ...
            if ('structure' === n.type || 'list' === n.type) {
              ...
              'binary' === n.type || n.isStreaming
                ? (e.data[r.payload] = i)
                : (e.data[r.payload] = n.toType(i));
          } else {
            var s = e.data;
            l.extractData(e), (e.data = u.merge(s, e.data));
          }
        }
        var u = e('../util'),
          c = e('./rest'),
      ...
      function(e, t, r) {
        function n(e) {
          ...
          (r.headers['Content-Type'] =
            'application/x-www-form-urlencoded; charset=utf-8'), (r.params = {
        ...
        function i(e) {
          ...
          t.requestId &&
            !e.requestId &&
            (e.requestId = t.requestId), t.Errors && (t = t.Errors), t.Error &&
            (t = t.Error), t.Code
        ...
        function o(e) {
          ...
          if (i.resultWrapper) {
            ...
            (o.members[i.resultWrapper] = n), (o.memberNames = [
              i.resultWrapper
            ]), a.property(n, 'name', n.resultWrapper), (n = o);
          }
          ...
          (e.requestId = h._XAMZRequestId || h.requestId), h._XAMZRequestId &&
            delete h._XAMZRequestId, i.resultWrapper &&
            h[i.resultWrapper] &&
            (
              a.update(h, h[i.resultWrapper]),
              delete h[i.resultWrapper]
            ), (e.data = h);
        }
        var s = e('../core'),
          a = e('../util'),
      ...
      function(e, t, r) {
        ...
        function i(e, t) {
          e.constructor.prototype[t] ||
            g.memoizedProperty.apply(this, arguments);
        }
        function o(e, t, r) {
          (t = t || {}), n(this, 'shape', e.shape), n(
            this,
            'api',
            t.api,
            !1
          ), n(this, 'type', e.type), n(this, 'enum', e.enum), n(
            this,
            'min',
            e.min
          ), n(this, 'max', e.max), n(this, 'pattern', e.pattern), n(
            this,
            'location',
            e.location || this.location || 'body'
          ), n(
            this,
            'name',
            this.name || e.xmlName || e.queryName || e.locationName || r
          ), n(this, 'isStreaming', e.streaming || this.isStreaming || !1), n(
            this,
            'isComposite',
            e.isComposite || !1
          ), n(this, 'isShape', !0, !1), n(
            this,
            'isQueryName',
            Boolean(e.queryName),
            !1
          ), n(this, 'isLocationName', Boolean(e.locationName), !1), n(
            this,
            'isIdempotent',
            !0 === e.idempotencyToken
          ), n(this, 'isJsonValue', !0 === e.jsonvalue), t.documentation &&
            (
              n(this, 'documentation', e.documentation),
              n(this, 'documentationUrl', e.documentationUrl)
            ), e.xmlAttribute &&
            n(this, 'isXmlAttribute', e.xmlAttribute || !1), n(
            this,
            'defaultValue',
            null
        ...
        function s(e) {
          o.apply(this, arguments), n(this, 'isComposite', !0), e.flattened &&
            n(this, 'flattened', e.flattened || !1);
        }
        function a(e, t) {
          var r = null,
            a = !this.isShape;
          s.apply(this, arguments), a &&
            (
            ...
            (
              n(
                this,
                'members',
                new m(e.members, t, function(e, r) {
            ...
            ), n(this, 'resultWrapper', e.resultWrapper || null), e.payload &&
            n(this, 'payload', e.payload), 'string' == typeof e.xmlNamespace
        ...
        function l(e) {
          var t = this;
          if ((o.apply(this, arguments), 'header' === this.location))
        ...
        function h() {
          ...
          (this.toType = function(t) {
            return (t =
              this.api && e.indexOf(this.api.protocol) > -1 ? t || '' : t), this
              .isJsonValue
              ? JSON.parse(t)
              : t && 'function' == typeof t.toString ? t.toString() : t;
          }), (this.toWireFormat = function(e) {
        ...
        function d() {
          o.apply(this, arguments), (this.toType =
            g.base64.decode), (this.toWireFormat = g.base64.encode);
        }
        function y() {
        ...
        (o.normalizedTypes = {
          ...
          e.type ||
            (e.members
              ...
              : e.member
                ? (e.type = 'list')
                : e.key ? (e.type = 'map') : (e.type = 'string'));
          var a = e.type;
          if (
            (
              o.normalizedTypes[e.type] && (e.type = o.normalizedTypes[e.type]),
              o.types[e.type]
            )
          )
    ...
    220: [
      function(e, t, r) {
        function n(e) {
          var t = e.httpRequest,
            ...
            s = new a();
          1 === i && (i = '1.0'), (t.body = s.build(
            e.params || {},
            o
          )), (t.headers['Content-Type'] =
            'application/x-amz-json-' + i), (t.headers['X-Amz-Target'] = n);
        }
        function i(e) {
          var t = {},
            r = e.httpResponse;
          if (
            ...
            try {
              ...
              (n.__type || n.code) &&
                (t.code = (n.__type || n.code)
                  .split('#')
                  .pop()), 'RequestEntityTooLarge' === t.code
            ...
            (t.statusCode =
              r.statusCode), (t.message = r.statusCode.toString());
      ...
      { '../json/builder': 210, '../json/parser': 211, '../util': 261 }
    ],
    211: [
      function(e, t, r) {
        function n() {}
        ...
        (function(r) {
          var n,
            i = {
              environment: 'nodejs',
              engine: function() {
                if (i.isBrowser() && 'undefined' != typeof navigator)
                  return navigator.userAgent;
                var e = r.platform + '/' + r.version;
                return r.env.AWS_EXECUTION_ENV &&
                  (e += ' exec-env/' + r.env.AWS_EXECUTION_ENV), e;
              },
              userAgent: function() {
                var t = i.environment,
              ...
              base64: {
                encode: function(e) {
                  ...
                  return null === e || void 0 === e
                    ? e
                    : ('function' == typeof i.Buffer.from &&
                      i.Buffer.from !== Uint8Array.from
                        ? i.Buffer.from(e)
                        : new i.Buffer(e)).toString('base64');
                },
                decode: function(e) {
                  if ('number' == typeof e)
                    throw i.error(
              ...
              buffer: {
                ...
                concat: function(e) {
                  ...
                  for (o = new i.Buffer(r), t = 0; t < e.length; t++)
              ...
              string: {
                byteLength: function(t) {
                  ...
                  if ('string' == typeof t.path)
                    return e('fs').lstatSync(t.path).size;
              ...
              date: {
                getDate: function() {
                  return n || (n = e('./core')), n.config.systemClockOffset
                    ? new Date(
                ...
                rfc822: function(e) {
                  return void 0 === e &&
                    (e = i.date.getDate()), e.toUTCString();
                },
                unixTimestamp: function(e) {
                  return void 0 === e && (e = i.date.getDate()), e.getTime() /
                    1e3;
                },
                from: function(e) {
              ...
              crypto: {
                ...
                hmac: function(e, t, r, n) {
                  return r || (r = 'binary'), 'buffer' === r &&
                    (r = void 0), n || (n = 'sha256'), 'string' == typeof t &&
                    (t = new i.Buffer(t)), i.crypto.lib
                    .createHmac(n, e)
                    .update(t)
                    .digest(r);
                },
                ...
                hash: function(e, t, r, n) {
                  ...
                  r || (r = 'binary'), 'buffer' === r &&
                    (r = void 0), 'string' == typeof t && (t = new i.Buffer(t));
                  ...
                  if (
                    ...
                    if (!n || !s || a || 'undefined' == typeof FileReader) {
                      i.isBrowser() &&
                        'object' == typeof t &&
                        !a &&
                        (t = new i.Buffer(new Uint8Array(t)));
                    ...
                    (l.onerror = function() {
                      ...
                      var e = c + 524288;
                      e > t.size && (e = t.size), l.readAsArrayBuffer(
                        s.call(t, c, e)
                      );
                    }), l._continueReading();
                  }
              ...
              isType: function(e, t) {
                return 'function' == typeof t &&
                  (t = i.typeName(t)), Object.prototype.toString.call(e) ===
                  '[object ' + t + ']';
              },
              typeName: function(e) {
              ...
              error: function(e, t) {
                ...
                return 'string' == typeof e.message &&
                  ...
                  ((r = i.copy(e)), (r.message = e.message)), (e.message =
                  e.message || null), 'string' == typeof t
                  ? (e.message = t)
                  : 'object' == typeof t &&
                    null !== t &&
                    (
              ...
              inherit: function(e, t) {
                ...
                return t.constructor === Object &&
                  ...
                  }), (t.constructor.prototype = r), i.update(
                  t.constructor.prototype,
                  t
                ), (t.constructor.__super__ = e), t.constructor;
              },
              mixin: function() {
              ...
              property: function(e, t, r, n, i) {
                ...
                'function' != typeof r || i
                  ...
                  : (o.get = r), Object.defineProperty(e, t, o);
              },
                ...
                if (i.isNode()) {
                  ...
                  if (t instanceof n) {
                    ...
                    'number' == typeof t.start &&
                      (s.start = t.start), 'number' == typeof t.end &&
                      (s.end = t.end), (t = o.createReadStream(t.path, s));
                  }
                }
              ...
              extractRequestId: function(e) {
                ...
                !t &&
                  ...
                  (t = e.data.ResponseMetadata.RequestId), t &&
                  (e.requestId = t), e.error && (e.error.requestId = t);
              },
                ...
                if (
                  (
                    void 0 === t &&
                      n &&
                      n.config &&
                      (t = n.config.getPromisesDependency()),
                    void 0 === t &&
              ...
              isDualstackAvailable: function(t) {
                ...
                return 'string' != typeof t && (t = t.serviceIdentifier), !(
                  'string' != typeof t || !r.hasOwnProperty(t)
                ) && !!r[t].dualstackAvailable;
              },
                      ...
                      function(e) {
                        e.on('data', function(e) {
                          ...
                          if (n < 300) r(null, t);
                            ...
                            var o =
                                1e3 * parseInt(e.headers['retry-after'], 10) ||
                                0,
                              s = i.error(new Error(), {
    ...
    193: [
      function(e, t, r) {
        ...
        (n.Config = n.util.inherit({
          constructor: function(e) {
            void 0 === e && (e = {}), (e = this.extractCredentials(
              e
          ...
          update: function(e, t) {
            (t = t || !1), (e = this.extractCredentials(
              e
          ...
          clear: function() {
            n.util.each.call(this, this.keys, function(e) {
              delete this[e];
            }), this.set('credentials', void 0), this.set(
              'credentialProvider',
              void 0
            );
          },
          ...
          extractCredentials: function(e) {
            return e.accessKeyId &&
              e.secretAccessKey &&
              ((e = n.util.copy(e)), (e.credentials = new n.Credentials(e))), e;
          },
          setPromisesDependency: function(e) {
            ...
            n.S3 &&
              n.S3.ManagedUpload &&
              t.push(n.S3.ManagedUpload), n.util.addPromises(t, i);
          },
    ...
    197: [
      function(e, t, r) {
        ...
        (n.CredentialProviderChain = n.util.inherit(n.Credentials, {
          constructor: function(e) {
            this.providers =
              e || n.CredentialProviderChain.defaultProviders.slice(0);
          },
          resolve: function(e) {
            function t(i, o) {
              if ((!i && o) || r === n.length) return void e(i, o);
              var s = n[r++];
              (o = 'function' == typeof s ? s.call() : s), o.get
                ? o.get(function(e) {
                    t(e, e ? null : o);
                  })
                : t(null, o);
        ...
        })), (n.CredentialProviderChain.defaultProviders = []), (n.CredentialProviderChain.addPromisesToClass = function(
          e
        ) {
        ...
        (n.Credentials = n.util.inherit({
          constructor: function() {
            if (
              ...
              (this.accessKeyId = e.accessKeyId), (this.secretAccessKey =
                e.secretAccessKey), (this.sessionToken = e.sessionToken);
            } else
              (this.accessKeyId = arguments[0]), (this.secretAccessKey =
          ...
          (this.prototype.getPromise = n.util.promisifyMethod(
            'get',
            e
          )), (this.prototype.refreshPromise = n.util.promisifyMethod(
            'refresh',
            e
          ));
        }), (n.Credentials.deletePromisesFromClass = function() {
          delete this.prototype.getPromise, delete this.prototype
            .refreshPromise;
    ...
    188: [
      function(e, t, r) {
        t.exports = {
          ...
          clouddirectory: { name: 'CloudDirectory' },
    ...
    187: [
      ...
      { './XMLBuilder': 172, 'lodash/assign': 129 }
    ],
    172: [
      function(e, t, r) {
        (function() {
          var r, n;
          (n = e('./XMLStringifier')), e('./XMLDeclaration'), e(
            './XMLDocType'
          ), (r = e('./XMLElement')), (t.exports = (function() {
            function e(e, t) {
              var i, o;
              if (null == e) throw new Error('Root element needs a name');
              null == t &&
                (t = {}), (this.options = t), (this.stringify = new n(
                t
              )), (o = new r(this, 'doc')), (i = o.element(
                e
              )), (i.isRoot = !0), (i.documentObject = this), (this.rootObject = i), t.headless ||
                (
                  i.declaration(t),
                  (null == t.pubID && null == t.sysID) || i.doctype(t)
                );
            }
            return (e.prototype.root = function() {
              ...
              var t, r, n, i, o, s;
              return (r = (null != e ? e.pretty : void 0) || !1), null !=
              (i = null != e ? e.indent : void 0)
                ? i
                : '  ', null != (o = null != e ? e.offset : void 0)
                ? o
                : 0, (t =
                null != (s = null != e ? e.newline : void 0) ? s : '\n'), (n =
                ''), null != this.xmldec &&
                (n += this.xmldec.toString(e)), null != this.doctype &&
                (n += this.doctype.toString(e)), (n += this.rootObject.toString(
                e
              )), r &&
                n.slice(-t.length) === t &&
                (n = n.slice(0, -t.length)), n;
            }), e;
          })());
        }.call(this));
      },
          ...
          t.exports = (function() {
            function t(t) {
              ...
              (this.allowSurrogateChars =
                null != t
                  ? t.allowSurrogateChars
                  : void 0), (this.noDoubleEncoding =
                null != t ? t.noDoubleEncoding : void 0), (i =
                (null != t ? t.stringify : void 0) || {});
            ...
            return (t.prototype.eleName = function(e) {
              ...
              return '' + e || '';
            }), (t.prototype.convertAttKey = '@'), (t.prototype.convertPIKey =
              '?'), (t.prototype.convertTextKey =
              '#text'), (t.prototype.convertCDataKey =
              '#cdata'), (t.prototype.convertCommentKey =
              '#comment'), (t.prototype.convertRawKey =
              '#raw'), (t.prototype.assertLegalChar = function(e) {
              var t, r;
              if (
                (
              ...
              var t;
              return (t = this.noDoubleEncoding
                ? /(?!&\S+;)&/g
                : /&/g), e
                .replace(t, '&amp;')
                .replace(/</g, '&lt;')
        ...
        (function() {
          var r,
            ...
            i = function(e, t) {
              ...
              return (r.prototype =
                t.prototype), (e.prototype = new r()), (e.__super__ =
                t.prototype), e;
            },
            o = {}.hasOwnProperty;
          e('lodash/create'), (n = e('lodash/isObject')), (r = e(
            './XMLNode'
          )), (t.exports = (function(e) {
            function t(e, r, i, o) {
              var s;
              t.__super__.constructor.call(this, e), n(r) &&
                (
                  (s = r),
                  (r = s.version),
                  (i = s.encoding),
                  (o = s.standalone)
                ), r || (r = '1.0'), (this.version = this.stringify.xmlVersion(
                r
              )), null != i &&
                (this.encoding = this.stringify.xmlEncoding(i)), null != o &&
                (this.standalone = this.stringify.xmlStandalone(o));
            }
            return i(t, e), (t.prototype.toString = function(e, t) {
              var r, n, i, o, s, a, u, c, l;
              return (o = (null != e ? e.pretty : void 0) || !1), (r =
                null != (a = null != e ? e.indent : void 0) ? a : '  '), (i =
                null != (u = null != e ? e.offset : void 0) ? u : 0), (n =
                null != (c = null != e ? e.newline : void 0) ? c : '\n'), t ||
                (t = 0), (l = new Array(t + i + 1).join(r)), (s = ''), o &&
                (s += l), (s += '<?xml'), (s +=
                ' version="' + this.version + '"'), null != this.encoding &&
                (s += ' encoding="' + this.encoding + '"'), null !=
                this.standalone &&
                (s += ' standalone="' + this.standalone + '"'), (s +=
                '?>'), o && (s += n), s;
            }), t;
          })(r));
        }.call(this));
      },
      { './XMLNode': 182, 'lodash/create': 131, 'lodash/isObject': 144 }
    ],
    182: [
      function(e, t, r) {
        (function() {
          var r,
            ...
            h,
            f = {}.hasOwnProperty;
          (h = e('lodash/isObject')), (l = e('lodash/isFunction')), (c = e(
            'lodash/isEmpty'
          )), (s = null), (r = null), (n = null), (i = null), (o = null), (a = null), (u = null), (t.exports = (function() {
            function t(t) {
              (this.parent = t), (this.options = this.parent.options), (this.stringify = this.parent.stringify), null ===
                s &&
                (
                  (s = e('./XMLElement')),
                  (r = e('./XMLCData')),
            ...
            return (t.prototype.element = function(e, t, r) {
              ...
              if (
                (
                  ...
                  null == t && (t = {}),
                  (t = t.valueOf()),
                  h(t) || ((y = [t, r]), (r = y[0]), (t = y[1])),
                  null != e && (e = e.valueOf()),
                  Array.isArray(e)
                )
              )
                for (o = 0, p = e.length; o < p; o++)
                  (i = e[o]), (u = this.element(i));
                ...
                for (a in e)
                  if (f.call(e, a))
                    if (
                      ...
                      0 === a.indexOf(this.stringify.convertPIKey)
                    )
                      u = this.instruction(
                        a.substr(this.stringify.convertPIKey.length),
                        v
                      );
                    else if (
                      ...
                      for (s = 0, d = v.length; s < d; s++)
                        (i = v[s]), (n = {}), (n[a] = i), (u = this.element(n));
                    else
                      h(v)
                        ? ((u = this.element(a)), u.element(v))
                        : (u = this.element(a, v));
              } else
                u =
                  !this.options.ignoreDecorators &&
              ...
              return (i = this.parent.children.indexOf(
                this
              )), (o = this.parent.children.splice(
                i
              )), (n = this.parent.element(
                e,
                t,
                r
              )), Array.prototype.push.apply(this.parent.children, o), n;
              ...
              return (e = this.parent.children.indexOf(this)), [].splice.apply(
                this.parent.children,
                [e, e - e + 1].concat([])
              ), this.parent;
            }), (t.prototype.node = function(e, t, r) {
              var n, i;
              return null != e && (e = e.valueOf()), null == t &&
                (t = {}), (t = t.valueOf()), h(t) ||
                ((i = [t, r]), (r = i[0]), (t = i[1])), (n = new s(
                this,
                e,
                t
              )), null != r && n.text(r), this.children.push(n), n;
              ...
              var n, o;
              return (n = this.document()), (o = new i(
                n,
                e,
                t,
                r
              ...
              var r, n;
              return (r = this.document()), (n = new o(
                r,
                e,
                t
              )), (r.doctype = n), n;
              ...
              if (this.isRoot) throw new Error('Root node has no siblings');
              if (
                -1 === (e = this.parent.children.indexOf(this)) ||
                e === this.parent.children.length - 1
              )
              ...
              return (t = e
                .root()
                .clone()), (t.parent = this), (t.isRoot = !1), this.children.push(
                t
              ), this;
          ...
          (n = e('lodash/create')), (r = e(
            ...
            return i(t, e), (t.prototype.clone = function() {
              ...
              return (o = (null != e ? e.pretty : void 0) || !1), (r =
                ...
                null != (c = null != e ? e.newline : void 0) ? c : '\n'), t ||
                (t = 0), (l = new Array(t + i + 1).join(r)), (s = ''), o &&
                (s += l), (s += this.value), o && (s += n), s;
            }), t;
          })(r));
        }.call(this));
      },
      { './XMLNode': 182, 'lodash/create': 131 }
    ],
    184: [
      function(e, t, r) {
        (function() {
      ...
      function(e, t, r) {
        (function() {
          var r,
            ...
            l = {}.hasOwnProperty;
          (o = e('lodash/create')), (u = e('lodash/isObject')), (a = e(
            'lodash/isFunction'
          )), (s = e('lodash/every')), (n = e('./XMLNode')), (r = e(
            './XMLAttribute'
          )), (i = e('./XMLProcessingInstruction')), (t.exports = (function(e) {
            function t(e, r, n) {
              if ((t.__super__.constructor.call(this, e), null == r))
                throw new Error('Missing element name');
              (this.name = this.stringify.eleName(
                r
              )), (this.children = []), (this.instructions = []), (this.attributes = {}), null !=
                n && this.attribute(n);
            }
            return c(t, e), (t.prototype.clone = function() {
              var e, r, n, i, s, a, u, c;
              (n = o(t.prototype, this)), n.isRoot &&
                (n.documentObject = null), (n.attributes = {}), (u = this
                .attributes);
              for (r in u)
                l.call(u, r) && ((e = u[r]), (n.attributes[r] = e.clone()));
              for (
                n.instructions = [], c = this.instructions, i = 0, s = c.length;
                i < s;
                i++
              )
              ...
              if ((null != e && (e = e.valueOf()), u(e)))
                ...
                a(t) && (t = t.apply()), (this.options.skipNullAttributes &&
                  null == t) ||
              ...
              if (
                ...
                for (n in e)
                  l.call(e, n) && ((o = e[n]), this.instruction(n, o));
              else
                a(t) && (t = t.apply()), (s = new i(
                  this,
                  e,
                  t
              ...
              for (
                y = (null != e ? e.pretty : void 0) || !1, o =
                  null != (m = null != e ? e.indent : void 0) ? m : '  ', d =
                  null != (g = null != e ? e.offset : void 0) ? g : 0, p =
                  null != (_ = null != e ? e.newline : void 0) ? _ : '\n', t ||
                  (t = 0), E = new Array(t + d + 1).join(o), v = '', b = this
                  .instructions, i = 0, c = b.length;
                i < c;
                i++
              )
                (a = b[i]), (v += a.toString(e, t));
              ...
              if (
                ...
                (v += '>'), (v += this.children[0].value), (v +=
                  '</' + this.name + '>'), (v += p);
              else {
                for (
                  v += '>', y && (v += p), x = this.children, u = 0, h =
                    x.length;
                  u < h;
                  u++
                )
                  (n = x[u]), (v += n.toString(e, t + 1));
    ...
    180: [
      function(e, t, r) {
        (function() {
          var r, n, i, o, s, a, u, c;
          e('lodash/create'), (c = e('lodash/isObject')), (r = e(
            './XMLCData'
          )), (n = e('./XMLComment')), (i = e('./XMLDTDAttList')), (s = e(
            './XMLDTDEntity'
          )), (o = e('./XMLDTDElement')), (a = e('./XMLDTDNotation')), (u = e(
            './XMLProcessingInstruction'
          )), (t.exports = (function() {
            function e(e, t, r) {
              var n, i;
              (this.documentObject = e), (this.stringify = this.documentObject.stringify), (this.children = []), c(
                t
              ) && ((n = t), (t = n.pubID), (r = n.sysID)), null == r &&
                ((i = [t, r]), (r = i[0]), (t = i[1])), null != t &&
                (this.pubID = this.stringify.dtdPubID(t)), null != r &&
                (this.sysID = this.stringify.dtdSysID(r));
            }
            return (e.prototype.element = function(e, t) {
              ...
              var s;
              return (s = new i(this, e, t, r, n, o)), this.children.push(
                s
              ), this;
              ...
              if (
                (
                  (u = (null != e ? e.pretty : void 0) || !1),
                  (i = null != (l = null != e ? e.indent : void 0) ? l : '  '),
                  (a = null != (h = null != e ? e.offset : void 0) ? h : 0),
                  (s = null != (f = null != e ? e.newline : void 0) ? f : '\n'),
                  t || (t = 0),
                  (d = new Array(t + a + 1).join(i)),
                  (c = ''),
                  u && (c += d),
                  (c += '<!DOCTYPE ' + this.root().name),
                  this.pubID && this.sysID
                    ? (c += ' PUBLIC "' + this.pubID + '" "' + this.sysID + '"')
                    : this.sysID && (c += ' SYSTEM "' + this.sysID + '"'),
                  this.children.length > 0
                )
              ) {
                for (
                  c += ' [', u && (c += s), p = this.children, n = 0, o =
                    p.length;
                  n < o;
                  n++
                )
                  (r = p[n]), (c += r.toString(e, t + 1));
                c += ']';
              }
              return (c += '>'), u && (c += s), c;
        ...
        (function() {
          ...
          (r = e('lodash/create')), (t.exports = (function() {
            function e(e, t, r) {
              ...
              (this.target = this.stringify.insTarget(t)), r &&
                (this.value = this.stringify.insValue(r));
            }
            return (e.prototype.clone = function() {
              ...
              return (o = (null != e ? e.pretty : void 0) || !1), (r =
                ...
                null != (c = null != e ? e.newline : void 0) ? c : '\n'), t ||
                (t = 0), (l = new Array(t + i + 1).join(r)), (s = ''), o &&
                (s += l), (s += '<?'), (s += this.target), this.value &&
                (s += ' ' + this.value), (s += '?>'), o && (s += n), s;
            }), e;
          })());
        }.call(this));
      },
        ...
        (function() {
          e('lodash/create'), (t.exports = (function() {
            function e(e, t, r) {
              ...
              (this.name = this.stringify.eleName(t)), null != r.pubID &&
                (this.pubID = this.stringify.dtdPubID(r.pubID)), null !=
                r.sysID && (this.sysID = this.stringify.dtdSysID(r.sysID));
            }
            return (e.prototype.toString = function(e, t) {
              ...
              return (o = (null != e ? e.pretty : void 0) || !1), (r =
                ...
                null != (c = null != e ? e.newline : void 0) ? c : '\n'), t ||
                (t = 0), (l = new Array(t + i + 1).join(r)), (s = ''), o &&
                (s += l), (s += '<!NOTATION ' + this.name), this.pubID &&
              this.sysID
                ? (s += ' PUBLIC "' + this.pubID + '" "' + this.sysID + '"')
                : this.pubID
                  ? (s += ' PUBLIC "' + this.pubID + '"')
                  : this.sysID && (s += ' SYSTEM "' + this.sysID + '"'), (s +=
                '>'), o && (s += n), s;
            }), e;
          })());
        }.call(this));
      ...
      function(e, t, r) {
        (function() {
          ...
          e('lodash/create'), (r = e(
            ...
            function e(e, t, n, i) {
              if (((this.stringify = e.stringify), null == n))
                throw new Error('Missing entity name');
              if (null == i) throw new Error('Missing entity value');
              if (
                ((this.pe = !!t), (this.name = this.stringify.eleName(n)), r(i))
              ) {
                if (!i.pubID && !i.sysID)
                  throw new Error(
              ...
              return (o = (null != e ? e.pretty : void 0) || !1), (r =
                ...
                : (
                    this.pubID && this.sysID
                      ...
                      : this.sysID && (s += ' SYSTEM "' + this.sysID + '"'),
                    this.nData && (s += ' NDATA ' + this.nData)
                  ), (s += '>'), o && (s += n), s;
            }), e;
          })());
        }.call(this));
      },
      { 'lodash/create': 131, 'lodash/isObject': 144 }
    ],
    176: [
      function(e, t, r) {
        (function() {
          e('lodash/create'), (t.exports = (function() {
            function e(e, t, r) {
              ...
              r || (r = '(#PCDATA)'), Array.isArray(r) &&
                (r =
                  '(' + r.join(',') + ')'), (this.name = this.stringify.eleName(
                t
            ...
            return (e.prototype.toString = function(e, t) {
              ...
              return (o = (null != e ? e.pretty : void 0) || !1), (r =
                ...
                (t = 0), (l = new Array(t + i + 1).join(r)), (s = ''), o &&
                (s += l), (s +=
                '<!ELEMENT ' + this.name + ' ' + this.value + '>'), o &&
                (s += n), s;
            }), e;
          })());
        }.call(this));
        ...
        (function() {
          e('lodash/create'), (t.exports = (function() {
            function e(e, t, r, n, i, o) {
              ...
              (this.elementName = this.stringify.eleName(
                t
              )), (this.attributeName = this.stringify.attName(
                r
              )), (this.attributeType = this.stringify.dtdAttType(
                n
            ...
            return (e.prototype.toString = function(e, t) {
              ...
              return (o = (null != e ? e.pretty : void 0) || !1), (r =
                ...
                this.attributeName +
                ' ' +
                this.attributeType), '#DEFAULT' !== this.defaultValueType &&
                (s += ' ' + this.defaultValueType), this.defaultValue &&
                (s += ' "' + this.defaultValue + '"'), (s += '>'), o &&
                (s += n), s;
            }), e;
          })());
        }.call(this));
        ...
        (function() {
          ...
          (r = e('lodash/create')), (t.exports = (function() {
            function e(e, t, r) {
              ...
              (this.name = this.stringify.attName(
                t
    ...
    170: [
      function(e, t, r) {
        function n(e, t, r) {
          var n = (t && r) || 0;
          'string' == typeof e &&
            ((t = 'binary' == e ? new Array(16) : null), (e = null)), (e =
            e || {});
      ...
      { './lib/bytesToUuid': 167, './lib/rng': 168 }
    ],
    169: [
      function(e, t, r) {
        function n(e, t, r) {
          ...
          if (
            (
              p < 0 && void 0 === e.clockseq && (s = (s + 1) & 16383),
              (p < 0 || h > c) && void 0 === e.nsecs && (f = 0),
              f >= 1e4
            )
          )
          ...
          (i[n++] = (d >>> 24) & 255), (i[n++] = (d >>> 16) & 255), (i[n++] =
            (d >>> 8) & 255), (i[n++] = 255 & d);
          var y = (h / 4294967296 * 1e4) & 268435455;
          (i[n++] = (y >>> 8) & 255), (i[n++] = 255 & y), (i[n++] =
            ((y >>> 24) & 15) | 16), (i[n++] = (y >>> 16) & 255), (i[n++] =
            (s >>> 8) | 128), (i[n++] = 255 & s);
    ...
    165: [
        ...
        (function(t, n) {
          function i(e, t) {
            ...
            return arguments.length >= 3 &&
              (n.depth = arguments[2]), arguments.length >= 4 &&
              (n.colors = arguments[3]), y(t)
              ? (n.showHidden = t)
              : t && r._extend(n, t), w(n.showHidden) && (n.showHidden = !1), w(
              n.depth
            ) && (n.depth = 2), w(n.colors) && (n.colors = !1), w(
              n.customInspect
            ) && (n.customInspect = !0), n.colors && (n.stylize = o), u(
              n,
              e,
              n.depth
            );
          ...
          function u(e, t, n) {
            ...
            if (
              (
                x(t) && (m = ' ' + RegExp.prototype.toString.call(t)),
                S(t) && (m = ' ' + Date.prototype.toUTCString.call(t)),
                A(t) && (m = ' ' + l(t)),
                0 === s.length && (!g || 0 == t.length)
              )
            )
              return b[0] + m + b[1];
            if (n < 0)
          ...
          function c(e, t) {
            ...
            return g(t)
              ...
              : y(t)
                ? e.stylize('' + t, 'boolean')
                : v(t) ? e.stylize('null', 'null') : void 0;
          }
          function l(e) {
          ...
          (r.debuglog = function(e) {
            ...
            date: 'magenta',
            regexp: 'red'
          }), (r.isArray = d), (r.isBoolean = y), (r.isNull = v), (r.isNullOrUndefined = m), (r.isNumber = g), (r.isString = _), (r.isSymbol = b), (r.isUndefined = w), (r.isRegExp = x), (r.isObject = E), (r.isDate = S), (r.isError = A), (r.isFunction = C), (r.isPrimitive = R), (r.isBuffer = e(
            './support/isBuffer'
          ));
          var D = [
            'Jan',
      ...
      { './support/isBuffer': 164, _process: 154, inherits: 163 }
    ],
    164: [
      function(e, t, r) {
        t.exports = function(e) {
      ...
      function(e, t, r) {
        'function' == typeof Object.create
          ...
          : (t.exports = function(e, t) {
              ...
              var r = function() {};
              (r.prototype =
                t.prototype), (e.prototype = new r()), (e.prototype.constructor = e);
            });
      },
      {}
    ],
    ...
    67: [
      function(e, t, r) {
        function n(e) {
          return i(function(t, r) {
            ...
            for (
              s =
                e.length > 3 && 'function' == typeof s ? (i--, s) : void 0, a &&
                o(r[0], r[1], a) &&
                ((s = i < 3 ? void 0 : s), (i = 1)), t = Object(t);
              ++n < i;
      ...
      { './_baseRest': 58, './_isIterateeCall': 90 }
    ],
    90: [
      function(e, t, r) {
        function n(e, t, r) {
      ...
      { './_isIndex': 89, './eq': 132, './isArrayLike': 139, './isObject': 144 }
    ],
    58: [
      function(e, t, r) {
        function n(e, t) {
      ...
      { './_overRest': 114, './_setToString': 119, './identity': 136 }
    ],
    119: [
      function(e, t, r) {
      ...
      { './_baseSetToString': 59, './_shortOut': 120 }
    ],
    120: [
      function(e, t, r) {
        function n(e) {
    ...
    59: [
      ...
      { './_defineProperty': 70, './constant': 130, './identity': 136 }
    ],
    130: [
      function(e, t, r) {
        function n(e) {
      ...
      function(e, t, r) {
        function n(e, t, r) {
          return (t = o(void 0 === t ? e.length - 1 : t, 0)), function() {
            for (
              var n = arguments, s = -1, a = o(n.length - t, 0), u = Array(a);
              ++s < a;
      ...
      function(e, t, r) {
        function n(e) {
          return 'function' == typeof e
            ...
            : null == e
              ? s
              : 'object' == typeof e ? (a(e) ? o(e[0], e[1]) : i(e)) : u(e);
        }
    ...
    77: [
      ...
      { './_isStrictComparable': 95, './keys': 148 }
    ],
    95: [
      function(e, t, r) {
        function n(e) {
    ...
    47: [
      ...
      { './_baseIsEqualDeep': 48, './isObjectLike': 145 }
    ],
    48: [
      function(e, t, r) {
    ...
    75: [
      ...
      { './_baseGetAllKeys': 43, './_getSymbols': 80, './keys': 148 }
    ],
    80: [
      function(e, t, r) {
    ...
    71: [
      ...
      { './_SetCache': 21, './_arraySome': 32, './_cacheHas': 63 }
    ],
    63: [
      function(e, t, r) {
        function n(e, t) {
      ...
      function(e, t, r) {
        function n(e, t) {
          ...
          return (
            ...
            (a.test(e) || !s.test(e) || (null != t && e in Object(t)))
          );
        }
        var i = e('./isArray'),
          o = e('./isSymbol'),
    ...
    146: [
      ...
      { './_baseGetTag': 44, './isObjectLike': 145 }
    ],
    39: [
      function(e, t, r) {
        function n(e, t) {
    ...
    38: [
      ...
      { './_baseForOwn': 41, './_createBaseEach': 68 }
    ],
    68: [
      function(e, t, r) {
        function n(e, t) {
    ...
    148: [
      ...
      { './_arrayLikeKeys': 29, './_baseKeys': 53, './isArrayLike': 139 }
    ],
    139: [
      function(e, t, r) {
        function n(e) {
    ...
    53: [
      ...
      { './_isPrototype': 94, './_nativeKeys': 110 }
    ],
    110: [
      function(e, t, r) {
        var n = e('./_overArg'),
    ...
    65: [
      ...
      { './_assignValue': 33, './_baseAssignValue': 36 }
    ],
    33: [
      function(e, t, r) {
        function n(e, t, r) {
    ...
    147: [
      ...
      { './_baseIsTypedArray': 51, './_baseUnary': 62, './_nodeUtil': 111 }
    ],
    111: [
      function(e, t, r) {
        var n = e('./_freeGlobal'),
    ...
    51: [
      ...
      { './_baseGetTag': 44, './isLength': 143, './isObjectLike': 145 }
    ],
    143: [
      function(e, t, r) {
        function n(e) {
    ...
    137: [
      ...
      { './_baseIsArguments': 46, './isObjectLike': 145 }
    ],
    46: [
      function(e, t, r) {
        function n(e) {
    ...
    125: [
      ...
      { './_ListCache': 16, './_Map': 17, './_MapCache': 18 }
    ],
    124: [
      function(e, t, r) {
        function n(e) {
    ...
    21: [
      ...
      { './_MapCache': 18, './_setCacheAdd': 116, './_setCacheHas': 117 }
    ],
    117: [
      function(e, t, r) {
        function n(e) {
    ...
    101: [
      ...
      { './_Hash': 15, './_ListCache': 16, './_Map': 17 }
    ],
    17: [
      function(e, t, r) {
        var n = e('./_getNative'),
    ...
    44: [
      ...
      { './_Symbol': 23, './_getRawTag': 79, './_objectToString': 112 }
    ],
    112: [
      function(e, t, r) {
        function n(e) {
        ...
        !(function(e) {
          ...
          function f(e) {
            (this._interpreter = e), (this.functionTable = {
              abs: { _func: this._functionAbs, _signature: [{ types: [m] }] },
              avg: { _func: this._functionAvg, _signature: [{ types: [E] }] },
              ceil: { _func: this._functionCeil, _signature: [{ types: [m] }] },
              contains: {
                _func: this._functionContains,
                _signature: [{ types: [_, b] }, { types: [g] }]
              },
              ends_with: {
                _func: this._functionEndsWith,
                _signature: [{ types: [_] }, { types: [_] }]
              },
              floor: {
              ...
              length: {
                ...
                _signature: [{ types: [_, b, w] }]
              },
              map: {
                _func: this._functionMap,
                _signature: [{ types: [x] }, { types: [b] }]
              },
              max: {
              ...
              merge: {
                ...
                _signature: [{ types: [w], variadic: !0 }]
              },
              max_by: {
                _func: this._functionMaxBy,
                _signature: [{ types: [b] }, { types: [x] }]
              },
              ...
              type: { _func: this._functionType, _signature: [{ types: [g] }] },
              keys: { _func: this._functionKeys, _signature: [{ types: [w] }] },
              values: {
              ...
              join: {
                ...
                _signature: [{ types: [_] }, { types: [S] }]
              },
              reverse: {
                _func: this._functionReverse,
                _signature: [{ types: [_, b] }]
              },
              to_array: {
          ...
          c.prototype = {
            tokenize: function(e) {
              ...
              for (var r, n, i; this._current < e.length; )
                if (s(e[this._current]))
                  (r = this._current), (n = this._consumeUnquotedIdentifier(
                    e
                  )), t.push({
                ...
                else if (void 0 !== A[e[this._current]])
                  t.push({
                  ...
                  (r = this._current), (n = this._consumeQuotedIdentifier(
                    e
                  )), t.push({ type: 'QuotedIdentifier', value: n, start: r });
                else if ("'" === e[this._current])
                  (r = this._current), (n = this._consumeRawStringLiteral(
                    e
                  ...
                  (r = this._current), this._current++, '&' === e[this._current]
                    ? (
                        this._current++,
                        t.push({ type: 'And', value: '&&', start: r })
                      )
            ...
            _consumeUnquotedIdentifier: function(e) {
              ...
              for (
                this._current++;
                this._current < e.length && u(e[this._current]);
            ...
            _consumeLBracket: function(e) {
              var t = this._current;
              return this._current++, '?' === e[this._current]
            ...
            _consumeLiteral: function(e) {
              ...
              return (o = o.replace('\\`', '`')), (t = this._looksLikeJSON(o)
                ? JSON.parse(o)
                : JSON.parse('"' + o + '"')), this._current++, t;
            },
          ...
          (T.EOF = 0), (T.UnquotedIdentifier = 0), (T.QuotedIdentifier = 0), (T.Rbracket = 0), (T.Rparen = 0), (T.Comma = 0), (T.Rbrace = 0), (T.Number = 0), (T.Current = 0), (T.Expref = 0), (T.Pipe = 1), (T.Or = 2), (T.And = 3), (T.EQ = 5), (T.GT = 5), (T.LT = 5), (T.GTE = 5), (T.LTE = 5), (T.NE = 5), (T.Flatten = 9), (T.Star = 20), (T.Filter = 21), (T.Dot = 40), (T.Not = 45), (T.Lbrace = 50), (T.Lbracket = 55), (T.Lparen = 60), (l.prototype = {
            ...
            nud: function(e) {
              ...
              switch (e.type) {
                ...
                case 'Star':
                  return (t = { type: 'Identity' }), (r = null), (r =
              ...
              switch (e) {
                case 'Dot':
                  ...
                  return 'Star' !== this._lookahead(0)
                    ? (
                        (r = this._parseDotRHS(n)),
                        { type: 'Subexpression', children: [t, r] }
                      )
                    : (
                        this._advance(),
                ...
                case 'Lparen':
                  for (
                    ...
                    'Current' === this._lookahead(0)
                      ...
                      : (i = this.expression(0)), 'Comma' ===
                      this._lookahead(0) && this._match('Comma'), s.push(i);
            ...
            _parseMultiselectHash: function() {
              for (
                var e,
                  ...
                  n,
                  i = [],
                  o = ['UnquotedIdentifier', 'QuotedIdentifier'];
                ;
            ...
            visit: function(e, s) {
              ...
              switch (e.type) {
                case 'Field':
                  return null === s
                    ? null
                    : r(s) ? ((f = s[e.name]), void 0 === f ? null : f) : null;
                case 'Subexpression':
                  for (
                    c = this.visit(e.children[0], s), y = 1;
                    y < e.children.length;
                    y++
                  )
                ...
                case 'IndexExpression':
                  return (p = this.visit(e.children[0], s)), this.visit(
                    e.children[1],
                    p
                  );
                case 'Index':
                  if (!t(s)) return null;
                  var v = e.value;
                  return v < 0 && (v = s.length + v), (c = s[v]), void 0 ===
                    c && (c = null), c;
                case 'Slice':
                  if (!t(s)) return null;
                  ...
                  else for (y = _; y > b; y += w) c.push(s[y]);
                  return c;
                case 'Projection':
                  var x = this.visit(e.children[0], s);
                  if (!t(x)) return null;
                  for (d = [], y = 0; y < x.length; y++)
                    null !== (u = this.visit(e.children[1], x[y])) && d.push(u);
                  return d;
                case 'ValueProjection':
                  ...
                  for (y = 0; y < E.length; y++)
                    null !== (u = this.visit(e.children[1], E[y])) && d.push(u);
                  return d;
                case 'FilterProjection':
                  ...
                  for (y = 0; y < x.length; y++)
                    (a = this.visit(e.children[2], x[y])), i(a) || S.push(x[y]);
                  for (var C = 0; C < S.length; C++)
                    null !== (u = this.visit(e.children[1], S[C])) && A.push(u);
                  return A;
                case 'Comparator':
                  switch ((
                ...
                case 'Flatten':
                  ...
                  for (y = 0; y < R.length; y++)
                    (u = R[y]), t(u) ? T.push.apply(T, u) : T.push(u);
                  return T;
                case 'Identity':
                  return s;
                case 'MultiSelectList':
                  if (null === s) return null;
                  for (d = [], y = 0; y < e.children.length; y++)
                    d.push(this.visit(e.children[y], s));
                  return d;
                case 'MultiSelectHash':
                  ...
                  for (y = 0; y < e.children.length; y++)
                    (I = e.children[y]), (d[I.name] = this.visit(I.value, s));
                  return d;
                case 'OrExpression':
                  return (a = this.visit(e.children[0], s)), i(a) &&
                    (a = this.visit(e.children[1], s)), a;
                case 'AndExpression':
                  return (l = this.visit(e.children[0], s)), !0 === i(l)
                    ? l
                    : this.visit(e.children[1], s);
                case 'NotExpression':
                ...
                case 'Function':
                  var O = [];
                  for (y = 0; y < e.children.length; y++)
                    O.push(this.visit(e.children[y], s));
                  return this.runtime.callFunction(e.name, O);
                case 'ExpressionReference':
                  var j = e.children[0];
                  return (j.jmespathType = 'Expref'), j;
                default:
            ...
            callFunction: function(e, t) {
              ...
              return this._validateArgs(e, t, r._signature), r._func.call(
                this,
                t
              );
            },
            ...
            _functionToString: function(e) {
              return this._getTypeName(e[0]) === _
                ? e[0]
                : JSON.stringify(e[0]);
            },
            ...
            _functionMaxBy: function(e) {
              for (
                var t,
                  ...
                  n = e[1],
                  i = e[0],
                  o = this.createKeyFunction(n, [m, _]),
                  s = -1 / 0,
                  a = 0;
                a < i.length;
                a++
...
})(
  {
    190: [
      function(e, t, r) {
        e('./browser_loader');
        var n = e('./core');
        'undefined' != typeof window && (window.AWS = n), void 0 !== t &&
          (t.exports = n), 'undefined' != typeof self && (self.AWS = n);
      },
      { './browser_loader': 191, './core': 194 }
    ],
    191: [
      function(e, t, r) {
        (function(r) {
          var n = e('./util');
          (n.crypto.lib = e('crypto-browserify')), (n.Buffer = e(
            'buffer/'
          ).Buffer), (n.url = e('url/')), (n.querystring = e(
            'querystring/'
          )), (n.environment = 'js');
          var i = e('./core');
          (t.exports = i), e('./credentials'), e(
            './credentials/credential_provider_chain'
          ), e('./credentials/temporary_credentials'), e(
            './credentials/web_identity_credentials'
          ), e('./credentials/cognito_identity_credentials'), e(
            './credentials/saml_credentials'
          ), (i.XML.Parser = e('./xml/browser_parser')), e(
            './http/xhr'
          ), void 0 === r && (r = { browser: !0 });
        }.call(this, e('_process')));
      },
      {
        './core': 194,
      ...
      function(e, t, r) {
        ...
        function o(e, t) {
          ...
          return null === e
            ? r
            : (
                l.each(t.members, function(t, n) {
                  if (n.isXmlAttribute) {
                    if (
                      Object.prototype.hasOwnProperty.call(e.attributes, n.name)
                    ) {
                      var o = e.attributes[n.name].value;
                      r[t] = i({ textContent: o }, n);
                    }
                  } else {
        ...
        function a(e, t) {
          for (
            ...
            o.nodeName === n && r.push(i(o, t.member)), (o =
        ...
        function u(e, t) {
          if (e.getAttribute) {
            ...
            'base64' === r && (t = new h.create({ type: r }));
          }
          var n = e.textContent;
          return '' === n && (n = null), 'function' == typeof t.toType
            ? t.toType(n)
            : n;
        }
        function c(e) {
          ...
          if (!e.firstElementChild)
            return null === e.parentNode.parentNode
              ? {}
              : 0 === e.childNodes.length ? '' : e.textContent;
          for (
            ...
            Object.prototype.hasOwnProperty.call(t.members, n)
              ...
              : (t.members[n] = { name: n }), (r = r.nextElementSibling);
          }
          return o(e, t);
        }
        var l = e('../util'),
          ...
          try {
            if (window.DOMParser) {
              ...
              if (null === r.documentElement)
                throw l.error(new Error('Cannot parse empty document.'), {
                  code: 'XMLParserError',
                  retryable: !0
                });
      ...
      function(e, t, r) {
        ...
        e('../http'), (n.XHRClient = n.util.inherit({
          handleRequest: function(e, t, r, o) {
            ...
            80 !== a.port && 443 !== a.port && (c += ':' + a.port), (c +=
              e.path);
            var l = new XMLHttpRequest(),
              h = !1;
            (e.stream = l), l.addEventListener(
              'readystatechange',
              function() {
                try {
              ...
              !1 !== t.xhrAsync &&
              (l.timeout = t.timeout), t.xhrWithCredentials &&
              (l.withCredentials = !0);
            try {
        ...
        })), (n.HttpClient.prototype =
          n.XHRClient.prototype), (n.HttpClient.streamsApiVersion = 1);
      },
      { '../core': 194, '../http': 208, events: 10 }
    ],
    200: [
      function(e, t, r) {
        var n = e('../core');
        n.WebIdentityCredentials = n.util.inherit(n.Credentials, {
          constructor: function(e, t) {
            n.Credentials.call(
              this
            ), (this.expired = !0), (this.params = e), (this.params.RoleSessionName =
              this.params.RoleSessionName ||
              'web-identity'), (this.data = null), (this._clientConfig = n.util.copy(
              t || {}
            ));
          },
          refresh: function(e) {
    ...
    199: [
      function(e, t, r) {
        ...
        n.TemporaryCredentials = n.util.inherit(n.Credentials, {
          constructor: function(e, t) {
            n.Credentials.call(this), this.loadMasterCredentials(
              t
            ), (this.expired = !0), (this.params = e || {}), this.params
              .RoleArn &&
              (this.params.RoleSessionName =
          ...
          refresh: function(e) {
            ...
            t.createClients(), e ||
              ...
              (t.service.config.credentials = t.masterCredentials), (t.params
                .RoleArn
                ? t.service.assumeRole
                : t.service.getSessionToken).call(t.service, function(r, n) {
      ...
      function(e, t, r) {
        ...
        n.CognitoIdentityCredentials = n.util.inherit(n.Credentials, {
          ...
          constructor: function(e, t) {
            n.Credentials.call(
              this
            ), (this.expired = !0), (this.params = e), (this.data = null), (this._identityId = null), (this._clientConfig = n.util.copy(
              t || {}
            )), this.loadCachedId();
            var r = this;
          ...
          refresh: function(e) {
            var t = this;
            t.createClients(), (t.data = null), (t._identityId = null), t.getId(
              function(r) {
                r
          ...
          clearCachedId: function() {
            ...
            delete this.storage[this.localStorageKey.id + e + t], delete this
              .storage[this.localStorageKey.providers + e + t];
          },
          ...
          createClients: function() {
            ...
            if (
              ...
              (t.params = this.params), (this.cognito = new n.CognitoIdentity(
                t
              ));
            }
          ...
          cacheId: function(e) {
            (this._identityId =
              e.IdentityId), (this.params.IdentityId = this._identityId), n.util.isBrowser() &&
              (
            ...
            try {
              var e =
                ...
                'object' == typeof window.localStorage
                  ? window.localStorage
                  : {};
              return (e['aws.test-storage'] = 'foobar'), delete e[
                'aws.test-storage'
              ], e;
            } catch (e) {
              return {};
    ...
    162: [
      function(e, t, r) {
        ...
        function o(e) {
          return u(e) && (e = i(e)), e instanceof n
            ? e.format()
        ...
        (n.prototype.parse = function(e, t, r) {
          ...
          if (!E[i] && (s || (i && !S[i]))) {
            ...
            var h, d;
            (d = -1 === a ? n.lastIndexOf('@') : n.lastIndexOf('@', a)), -1 !==
              d &&
              (
                (h = n.slice(0, d)),
                (n = n.slice(d + 1)),
            ...
            -1 === a && (a = n.length), (this.host = n.slice(
              0,
              a
            )), (n = n.slice(a)), this.parseHost(), (this.hostname =
              this.hostname || '');
            var y =
              '[' === this.hostname[0] &&
            ...
            if (!y)
              for (
                var v = this.hostname.split(/\./), c = 0, C = v.length;
                c < C;
                c++
              ) {
                var R = v[c];
                if (R && !R.match(b)) {
                  for (var T = '', I = 0, O = R.length; I < O; I++)
                    R.charCodeAt(I) > 127 ? (T += 'x') : (T += R[I]);
                  if (!T.match(b)) {
                    var j = v.slice(0, c),
                      L = v.slice(c + 1),
                      P = R.match(w);
                    P && (j.push(P[1]), L.unshift(P[2])), L.length &&
                      (n = '/' + L.join('.') + n), (this.hostname = j.join(
                      '.'
                    ));
                    break;
                  }
            ...
            if (
              ...
              for (
                var k = this.hostname.split('.'), D = [], c = 0;
                c < k.length;
                ++c
              ) {
                var q = k[c];
            ...
            var M = this.port ? ':' + this.port : '',
              N = this.hostname || '';
            (this.host = N + M), (this.href += this.host), y &&
              (
          ...
          if (e.protocol && e.protocol !== r.protocol) {
            ...
            if (((r.protocol = e.protocol), e.host || E[e.protocol]))
              ...
              e.host || (e.host = ''), e.hostname || (e.hostname = ''), '' !==
                i[0] && i.unshift(''), i.length < 2 &&
                i.unshift(''), (r.pathname = i.join('/'));
            }
            if (
              (
                (r.search = e.search),
            ...
            return (r.slashes =
              r.slashes || e.slashes), (r.href = r.format()), r;
          }
          ...
          if (
                ...
                (
                  ...
                  e.protocol &&
                    (
                      ...
                      (e.port = null),
                      e.host &&
                        ('' === i[0] ? (i[0] = e.host) : i.unshift(e.host)),
                      (e.host = null)
                    ),
                  (f = f && ('' === i[0] || '' === d[0]))
                ),
            ...
            (r.host = e.host || '' === e.host ? e.host : r.host), (r.hostname =
              e.hostname || '' === e.hostname
                ? e.hostname
                : r.hostname), (r.search = e.search), (r.query =
              e.query), (d = i);
          else if (i.length)
            d || (d = []), d.pop(), (d = d.concat(i)), (r.search =
              e.search), (r.query = e.query);
          else if (!h(e.search)) {
            if (y) {
            ...
            return (r.search = e.search), (r.query = e.query), (l(r.pathname) &&
              l(r.search)) ||
              (r.path =
          ...
          for (
            ...
            (m = d[b]), '.' == m
              ? d.splice(b, 1)
              : '..' === m ? (d.splice(b, 1), _++) : _ && (d.splice(b, 1), _--);
          if (!f && !p) for (; _--; _) d.unshift('..');
          !f ||
            '' === d[0] ||
            (d[0] && '/' === d[0].charAt(0)) ||
            d.unshift(''), g && '/' !== d.join('/').substr(-1) && d.push('');
          ...
          return (f = f || (r.host && d.length)), f &&
            !w &&
            d.unshift(''), d.length
            ? (r.pathname = d.join('/'))
            : ((r.pathname = null), (r.path = null)), (l(r.pathname) &&
            l(r.search)) ||
            (r.path =
              (r.pathname ? r.pathname : '') +
              (r.search ? r.search : '')), (r.auth =
            e.auth || r.auth), (r.slashes =
            r.slashes || e.slashes), (r.href = r.format()), r;
      ...
      { punycode: 155, querystring: 158 }
    ],
    161: [
      function(e, t, r) {
        arguments[4][158][0].apply(r, arguments);
      },
      { './decode': 159, './encode': 160, dup: 158 }
    ],
    160: [
      function(e, t, r) {
        'use strict';
        ...
        t.exports = function(e, t, r, i) {
          ...
          for (var c = 0; c < u; ++c) {
            ...
            y >= 0
              ...
              : ((l = d), (h = '')), (f = decodeURIComponent(
              l
            )), (p = decodeURIComponent(h)), n(o, f)
              ? Array.isArray(o[f]) ? o[f].push(p) : (o[f] = [o[f], p])
              : (o[f] = p);
          }
          return o;
        };
    ...
    158: [
      function(e, t, r) {
        'use strict';
        (r.decode = r.parse = e('./decode')), (r.encode = r.stringify = e(
          './encode'
        ));
      },
      { './decode': 156, './encode': 157 }
    ],
    157: [
      function(e, t, r) {
        'use strict';
        ...
        t.exports = function(e, t, r, a) {
          return (t = t || '&'), (r = r || '='), null === e &&
            ...
            : a ? encodeURIComponent(i(a)) + r + encodeURIComponent(i(e)) : '';
        };
        var o =
            Array.isArray ||
            function(e) {
        ...
        t.exports = function(e, t, r, o) {
          ...
          for (var l = 0; l < c; ++l) {
            var h,
              ...
              v = y.indexOf(r);
            v >= 0
              ? ((h = y.substr(0, v)), (f = y.substr(v + 1)))
              : ((h = y), (f = '')), (p = decodeURIComponent(
              h
            )), (d = decodeURIComponent(f)), n(s, p)
              ? i(s[p]) ? s[p].push(d) : (s[p] = [s[p], d])
              : (s[p] = d);
          }
          return s;
        };
          ...
          !(function(n) {
            ...
            function f(e) {
              ...
              for (r = e.lastIndexOf(I), r < 0 && (r = 0), n = 0; n < r; ++n)
                e.charCodeAt(n) >= 128 && i('not-basic'), y.push(
                  e.charCodeAt(n)
                );
              for (o = r > 0 ? r + 1 : 0; o < v; ) {
                for (
                  s = m, a = 1, l = x;
                  o >= v && i('invalid-input'), (f = c(
                    e.charCodeAt(o++)
                  )), (f >= x || f > D((w - m) / a)) && i('overflow'), (m +=
                    f * a), (p = l <= _ ? E : l >= _ + S ? S : l - _), !(f < p);
                  l += x
                )
                  (d = x - p), a > D(w / d) && i('overflow'), (a *= d);
                (t = y.length + 1), (_ = h(m - s, t, 0 == s)), D(m / t) >
                  w - g && i('overflow'), (g += D(m / t)), (m %= t), y.splice(
                  m++,
                  0,
                  g
                );
            ...
            function p(e) {
              var t,
                ...
                b = [];
              for (
                e = a(e), v = e.length, t = T, r = 0, s = R, u = 0;
                u < v;
                ++u
              )
                (y = e[u]) < 128 && b.push(q(y));
              for (n = o = b.length, o && b.push(I); n < v; ) {
                for (c = w, u = 0; u < v; ++u)
                  (y = e[u]) >= t && y < c && (c = y);
                for (
                  m = n + 1, c - t > D((w - r) / m) && i('overflow'), r +=
                    (c - t) * m, t = c, u = 0;
                  u < v;
                  ++u
                )
            ...
            if (
              ...
              else for (b in _) _.hasOwnProperty(b) && (v[b] = _[b]);
            else n.punycode = _;
          })(this);
        }.call(
          this,
      ...
      function(e, t, r) {
        ...
        (t.exports = n), (n.EventEmitter = n), (n.prototype._events = void 0), (n.prototype._maxListeners = void 0), (n.defaultMaxListeners = 10), (n.prototype.setMaxListeners = function(
          ...
          if (i(r))
            switch (arguments.length) {
              ...
              case 3:
                ...
                break;
              default:
                (o = Array.prototype.slice.call(arguments, 1)), r.apply(
                  this,
                  o
                );
            }
            ...
            for (
              o = Array.prototype.slice.call(arguments, 1), c = r.slice(), n =
                c.length, u = 0;
              u < n;
              u++
            )
          ...
          return this._events || (this._events = {}), this._events
            ...
            : (this._events[e] = t), s(this._events[e]) &&
          ...
          if (
            ...
            1 === r.length
              ...
              : r.splice(n, 1), this._events.removeListener &&
              this.emit('removeListener', e, t);
          }
          return this;
    ...
    5: [
      function(e, t, r) {
        function n(e, t, r) {
          s.isBuffer(t) || (t = new s(t)), s.isBuffer(r) ||
            (r = new s(r)), t.length > f
            ? (t = e(t))
            : t.length < f && (t = s.concat([t, p], f));
          for (var n = new s(f), i = new s(f), o = 0; o < f; o++)
        ...
        function i(e, t) {
          ...
          return r || o('algorithm:', e, 'is not yet supported'), {
            update: function(e) {
              return s.isBuffer(e) || (e = new s(e)), i.push(e), (a +=
                e.length), this;
            },
            digest: function(e) {
              var o = s.concat(i),
      ...
      { './md5': 6, './rng': 7, './sha': 8, './sha256': 9, buffer: 3 }
    ],
    9: [
      function(e, t, r) {
        var n = e('./helpers'),
          ...
          p = function(e, t) {
            ...
            for (var m = 0; m < e.length; m += 16) {
              (r = x[0]), (n = x[1]), (o = x[2]), (s = x[3]), (p = x[4]), (d =
                x[5]), (y = x[6]), (v = x[7]);
              for (var g = 0; g < 64; g++)
                (E[g] =
                  g < 16
                    ? e[g + m]
                    : i(
                        i(i(f(E[g - 2]), E[g - 7]), h(E[g - 15])),
                        E[g - 16]
                      )), (_ = i(
                  i(i(i(v, l(p)), a(p, d, y)), w[g]),
                  E[g]
                )), (b = i(
                  c(r),
                  u(r, n, o)
              ...
              (x[0] = i(r, x[0])), (x[1] = i(n, x[1])), (x[2] = i(
                o,
                x[2]
              )), (x[3] = i(s, x[3])), (x[4] = i(p, x[4])), (x[5] = i(
                d,
                x[5]
              )), (x[6] = i(y, x[6])), (x[7] = i(v, x[7]));
            }
            return x;
          };
        t.exports = function(e) {
          ...
          for (
            ...
            for (var p = n, d = u, y = c, v = l, m = h, g = 0; g < 80; g++) {
              r[g] =
                g < 16
                  ? e[f + g]
                  : a(r[g - 3] ^ r[g - 8] ^ r[g - 14] ^ r[g - 16], 1);
              var _ = s(s(a(n, 5), i(g, u, c, l)), s(s(h, r[g]), o(g)));
              (h = l), (l = c), (c = a(u, 30)), (u = n), (n = _);
            }
            (n = s(n, p)), (u = s(u, d)), (c = s(c, y)), (l = s(l, v)), (h = s(
              h,
              m
            ));
          }
      ...
      function(e, t, r) {
        !(function() {
          var e,
            ...
            n = this;
          (e = function(e) {
            for (var t, t, r = new Array(e), n = 0; n < e; n++)
              0 == (3 & n) && (t = 4294967296 * Math.random()), (r[n] =
                (t >>> ((3 & n) << 3)) & 255);
            return r;
          }), n.crypto &&
        ...
        function n(e, t) {
          ...
          for (
            ...
            var f = r,
              ...
              d = i,
              y = l;
            (r = o(r, n, i, l, e[h + 0], 7, -680876936)), (l = o(
              l,
              r,
              n,
              i,
              ...
              12,
              -389564586
            )), (i = o(i, l, r, n, e[h + 2], 17, 606105819)), (n = o(
              n,
              i,
              l,
              r,
              ...
              22,
              -1044525330
            )), (r = o(r, n, i, l, e[h + 4], 7, -176418897)), (l = o(
              l,
              r,
              n,
              i,
              ...
              12,
              1200080426
            )), (i = o(i, l, r, n, e[h + 6], 17, -1473231341)), (n = o(
              n,
              i,
              l,
              r,
              ...
              22,
              -45705983
            )), (r = o(r, n, i, l, e[h + 8], 7, 1770035416)), (l = o(
              l,
              r,
              n,
              i,
              ...
              12,
              -1958414417
            )), (i = o(i, l, r, n, e[h + 10], 17, -42063)), (n = o(
              n,
              i,
              l,
              r,
              ...
              22,
              -1990404162
            )), (r = o(r, n, i, l, e[h + 12], 7, 1804603682)), (l = o(
              l,
              r,
              n,
              i,
              ...
              12,
              -40341101
            )), (i = o(i, l, r, n, e[h + 14], 17, -1502002290)), (n = o(
              n,
              i,
              l,
              r,
              ...
              22,
              1236535329
            )), (r = s(r, n, i, l, e[h + 1], 5, -165796510)), (l = s(
              l,
              r,
              n,
              i,
              ...
              9,
              -1069501632
            )), (i = s(i, l, r, n, e[h + 11], 14, 643717713)), (n = s(
              n,
              i,
              l,
              r,
              ...
              20,
              -373897302
            )), (r = s(r, n, i, l, e[h + 5], 5, -701558691)), (l = s(
              l,
              r,
              n,
              i,
              ...
              9,
              38016083
            )), (i = s(i, l, r, n, e[h + 15], 14, -660478335)), (n = s(
              n,
              i,
              l,
              r,
              ...
              20,
              -405537848
            )), (r = s(r, n, i, l, e[h + 9], 5, 568446438)), (l = s(
              l,
              r,
              n,
              i,
              ...
              9,
              -1019803690
            )), (i = s(i, l, r, n, e[h + 3], 14, -187363961)), (n = s(
              n,
              i,
              l,
              r,
              ...
              20,
              1163531501
            )), (r = s(r, n, i, l, e[h + 13], 5, -1444681467)), (l = s(
              l,
              r,
              n,
              i,
              ...
              9,
              -51403784
            )), (i = s(i, l, r, n, e[h + 7], 14, 1735328473)), (n = s(
              n,
              i,
              l,
              r,
              ...
              20,
              -1926607734
            )), (r = a(r, n, i, l, e[h + 5], 4, -378558)), (l = a(
              l,
              r,
              n,
              i,
              ...
              11,
              -2022574463
            )), (i = a(i, l, r, n, e[h + 11], 16, 1839030562)), (n = a(
              n,
              i,
              l,
              r,
              ...
              23,
              -35309556
            )), (r = a(r, n, i, l, e[h + 1], 4, -1530992060)), (l = a(
              l,
              r,
              n,
              i,
              ...
              11,
              1272893353
            )), (i = a(i, l, r, n, e[h + 7], 16, -155497632)), (n = a(
              n,
              i,
              l,
              r,
              ...
              23,
              -1094730640
            )), (r = a(r, n, i, l, e[h + 13], 4, 681279174)), (l = a(
              l,
              r,
              n,
              i,
              ...
              11,
              -358537222
            )), (i = a(i, l, r, n, e[h + 3], 16, -722521979)), (n = a(
              n,
              i,
              l,
              r,
              ...
              23,
              76029189
            )), (r = a(r, n, i, l, e[h + 9], 4, -640364487)), (l = a(
              l,
              r,
              n,
              i,
              ...
              11,
              -421815835
            )), (i = a(i, l, r, n, e[h + 15], 16, 530742520)), (n = a(
              n,
              i,
              l,
              r,
              ...
              23,
              -995338651
            )), (r = u(r, n, i, l, e[h + 0], 6, -198630844)), (l = u(
              l,
              r,
              n,
              i,
              ...
              10,
              1126891415
            )), (i = u(i, l, r, n, e[h + 14], 15, -1416354905)), (n = u(
              n,
              i,
              l,
              r,
              ...
              21,
              -57434055
            )), (r = u(r, n, i, l, e[h + 12], 6, 1700485571)), (l = u(
              l,
              r,
              n,
              i,
              ...
              10,
              -1894986606
            )), (i = u(i, l, r, n, e[h + 10], 15, -1051523)), (n = u(
              n,
              i,
              l,
              r,
              ...
              21,
              -2054922799
            )), (r = u(r, n, i, l, e[h + 8], 6, 1873313359)), (l = u(
              l,
              r,
              n,
              i,
              ...
              10,
              -30611744
            )), (i = u(i, l, r, n, e[h + 6], 15, -1560198380)), (n = u(
              n,
              i,
              l,
              r,
              ...
              21,
              1309151649
            )), (r = u(r, n, i, l, e[h + 4], 6, -145523070)), (l = u(
              l,
              r,
              n,
              i,
              ...
              10,
              -1120210379
            )), (i = u(i, l, r, n, e[h + 2], 15, 718787259)), (n = u(
              n,
              i,
              l,
              r,
              ...
              21,
              -343485551
            )), (r = c(r, f)), (n = c(n, p)), (i = c(i, d)), (l = c(l, y));
          }
    ...
    4: [
      function(e, t, r) {
        ...
        function i(e, t, r) {
          for (
            var n = new s(t), i = r ? n.writeInt32BE : n.writeInt32LE, o = 0;
            o < e.length;
            o++
          )
            i.call(n, e[o], 4 * o, !0);
        ...
        function o(e, t, r, o) {
          return s.isBuffer(e) || (e = new s(e)), i(
            t(n(e, o), e.length * c),
            r,
            o
          );
    ...
    3: [
        ...
        (function(t) {
          ...
          function u(e, t, r, n) {
            return a(t), t <= 0
              ? i(e, t)
              : void 0 !== r
                ? 'string' == typeof n ? i(e, t).fill(r, n) : i(e, t).fill(r)
                : i(e, t);
          }
          function c(e, t) {
            if (
              (a(t), (e = i(e, t < 0 ? 0 : 0 | d(t))), !o.TYPED_ARRAY_SUPPORT)
            )
          ...
          function f(e, t, r, n) {
            ...
            return (t =
              void 0 === r && void 0 === n
                ...
                : void 0 === n
                  ? new Uint8Array(t, r)
                  : new Uint8Array(t, r, n)), o.TYPED_ARRAY_SUPPORT
          ...
          function K(e, t) {
            for (
              ...
              (r = e.charCodeAt(s)), (n = r >> 8), (i = r % 256), o.push(
                i
              ), o.push(n);
            return o;
          }
          ...
          (r.Buffer = o), (r.SlowBuffer = y), (r.INSPECT_MAX_BYTES = 50), (o.TYPED_ARRAY_SUPPORT =
            void 0 !== t.TYPED_ARRAY_SUPPORT
              ...
              : (function() {
                ...
                })()), (r.kMaxLength = n()), (o.poolSize = 8192), (o._augment = function(
            e
          ) {
          ...
          (o.prototype.slice = function(e, t) {
            ...
            return t || k(e, 4, this.length), (this[e] |
              (this[e + 1] << 8) |
              (this[e + 2] << 16)) +
              16777216 * this[e + 3];
          }), (o.prototype.readUInt32BE = function(e, t) {
            return t || k(e, 4, this.length), 16777216 * this[e] +
            ...
            return t || k(e, 1, this.length), 128 & this[e]
              ? -1 * (255 - this[e] + 1)
              : this[e];
            ...
            return t || k(e, 4, this.length), (this[e] << 24) |
              (this[e + 1] << 16) |
              (this[e + 2] << 8) |
              this[e + 3];
            ...
            return (e = +e), (t |= 0), r ||
              D(this, e, t, 1, 255, 0), o.TYPED_ARRAY_SUPPORT ||
              (e = Math.floor(e)), (this[t] = 255 & e), t + 1;
          }), (o.prototype.writeUInt16LE = function(e, t, r) {
            return (e = +e), (t |= 0), r ||
              D(this, e, t, 2, 65535, 0), o.TYPED_ARRAY_SUPPORT
            ...
            return (e = +e), (t |= 0), r ||
              D(this, e, t, 4, 4294967295, 0), o.TYPED_ARRAY_SUPPORT
              ? (
                  (this[t + 3] = e >>> 24),
                  (this[t + 2] = e >>> 16),
                  (this[t + 1] = e >>> 8),
            ...
            return (e = +e), (t |= 0), r ||
              D(this, e, t, 1, 127, -128), o.TYPED_ARRAY_SUPPORT ||
              (e = Math.floor(e)), e < 0 && (e = 255 + e + 1), (this[t] =
              255 & e), t + 1;
          }), (o.prototype.writeInt16LE = function(e, t, r) {
            return (e = +e), (t |= 0), r ||
              D(this, e, t, 2, 32767, -32768), o.TYPED_ARRAY_SUPPORT
              ? ((this[t] = 255 & e), (this[t + 1] = e >>> 8))
              : q(this, e, t, !0), t + 2;
            ...
            return (e = +e), (t |= 0), r ||
              D(this, e, t, 4, 2147483647, -2147483648), o.TYPED_ARRAY_SUPPORT
              ? (
                  (this[t] = 255 & e),
                  (this[t + 1] = e >>> 8),
                  (this[t + 2] = e >>> 16),
            ...
            if (t < 0 || this.length < t || this.length < r)
              throw new RangeError('Out of range index');
            if (r <= t) return this;
            (t >>>= 0), (r = void 0 === r ? this.length : r >>> 0), e ||
              (e = 0);
            var s;
      ...
      { 'base64-js': 1, ieee754: 11, isarray: 12 }
    ],
    12: [
      function(e, t, r) {
        var n = {}.toString;
      ...
      function(e, t, r) {
        ...
        function o(e) {
          ...
          for (t = 0; t < r; t += 4)
            (i =
              ...
              l[e.charCodeAt(t + 3)]), (s[u++] = (i >> 16) & 255), (s[u++] =
              (i >> 8) & 255), (s[u++] = 255 & i);
          return 2 === o
            ? (
        ...
        function a(e, t, r) {
          for (var n, i = [], o = t; o < r; o += 3)
            (n = (e[o] << 16) + (e[o + 1] << 8) + e[o + 2]), i.push(s(n));
          return i.join('');
        }
        function u(e) {
          for (
            var t, r = e.length, n = r % 3, i = '', o = [], s = 0, u = r - n;
            s < u;
            s += 16383
          )
...
(AWS.apiLoader.services.dynamodb = {}), (AWS.DynamoDB = AWS.Service.defineService(
  ...
  for (
    var u = 'function' == typeof _xamzrequire && _xamzrequire, i = 0;
    i < n.length;
    i++
  )
    a(n[i]);
...
})(
  {
    239: [
      function(e, t, r) {
        var n = e('../core');
        e('../dynamodb/document_client'), n.util.update(n.DynamoDB.prototype, {
          setupRequestListeners: function(e) {
            e.service.config.dynamoDbCrc32 &&
              (
                e.removeListener(
                  'extractData',
                  n.EventListeners.Json.EXTRACT_DATA
                ),
                e.addListener('extractData', this.checkCrc32),
                e.addListener('extractData', n.EventListeners.Json.EXTRACT_DATA)
              );
          },
          checkCrc32: function(e) {
            if (!e.httpResponse.streaming && !e.request.service.crc32IsValid(e))
              throw (
                (e.data = null),
                ...
                e.request.haltHandlersOnError(),
                e.error
              );
          },
          crc32IsValid: function(e) {
            var t = e.httpResponse.headers['x-amz-crc32'];
            return (
              !t || parseInt(t, 10) === n.util.crypto.crc32(e.httpResponse.body)
            );
          },
          defaultRetryCount: 10,
          retryDelays: function(e) {
            var t = n.util.copy(this.config.retryDelayOptions);
            return 'number' != typeof t.base &&
              (t.base = 50), n.util.calculateRetryDelay(e, t);
          }
        });
      },
      { '../core': 194, '../dynamodb/document_client': 202 }
    ],
    202: [
      function(e, t, r) {
        var n = e('../core'),
        ...
        (n.DynamoDB.DocumentClient = n.util.inherit({
          ...
          constructor: function(e) {
            var t = this;
            (t.options = e || {}), t.configure(t.options);
          },
          configure: function(e) {
            var t = this;
            (t.service = e.service), t.bindServiceObject(
              e
            ), (t.attrValue = e.attrValue =
              t.service.api.operations.putItem.input.members.Item.value.shape);
          },
          bindServiceObject: function(e) {
            var t = this;
            if (((e = e || {}), t.service)) {
              var r = n.util.copy(t.service.config);
              (t.service = new t.service.constructor.__super__(
                r
              )), (t.service.config.params = n.util.merge(
                t.service.config.params || {},
                e.params
              ));
            } else t.service = new n.DynamoDB(e);
          },
          batchGet: function(e, t) {
            var r = this,
              n = r.service.batchGetItem(e);
            return r.setupRequest(n), r.setupResponse(n), 'function' ==
              typeof t && n.send(t), n;
          },
          batchWrite: function(e, t) {
            var r = this,
              n = r.service.batchWriteItem(e);
            return r.setupRequest(n), r.setupResponse(n), 'function' ==
              typeof t && n.send(t), n;
          },
          delete: function(e, t) {
            var r = this,
              n = r.service.deleteItem(e);
            return r.setupRequest(n), r.setupResponse(n), 'function' ==
              typeof t && n.send(t), n;
          },
          get: function(e, t) {
            var r = this,
              n = r.service.getItem(e);
            return r.setupRequest(n), r.setupResponse(n), 'function' ==
              typeof t && n.send(t), n;
          },
          put: function(e, t) {
            var r = this,
              n = r.service.putItem(e);
            return r.setupRequest(n), r.setupResponse(n), 'function' ==
              typeof t && n.send(t), n;
          },
          update: function(e, t) {
            var r = this,
              n = r.service.updateItem(e);
            return r.setupRequest(n), r.setupResponse(n), 'function' ==
              typeof t && n.send(t), n;
          },
          scan: function(e, t) {
          ...
          createSet: function(e, t) {
            return (t = t || {}), new u(e, t);
          },
          getTranslator: function() {
            return new a(this.options);
          },
          setupRequest: function(e) {
            var t = this,
              r = t.getTranslator(),
              a = e.operation,
              u = e.service.api.operations[a].input;
            e._events.validate.unshift(function(e) {
              (e.rawParams = n.util.copy(
                e.params
              )), (e.params = r.translateInput(e.rawParams, u));
            });
          },
          setupResponse: function(e) {
            var t = this,
              r = t.getTranslator(),
              a = t.service.api.operations[e.operation].output;
            e.on('extractData', function(e) {
              e.data = r.translateOutput(e.data, a);
            }), (e.response.nextPage = function(e) {
              var r,
                a = this,
                u = a.request,
                i = u.service,
                o = u.operation;
              try {
                r = i.paginationConfig(o, !0);
              } catch (e) {
                a.error = e;
              }
              if (!a.hasNextPage()) {
                if (e) e(a.error, null);
                else if (a.error) throw a.error;
                return null;
              }
              var s = n.util.copy(u.rawParams);
              if (a.nextPageTokens) {
                var c = r.inputToken;
                'string' == typeof c && (c = [c]);
                for (var p = 0; p < c.length; p++)
                  s[c[p]] = a.nextPageTokens[p];
                return t[o](s, e);
              }
              return e ? e(null, null) : null;
            });
          }
        })), (t.exports = n.DynamoDB.DocumentClient);
      },
      { '../core': 194, './set': 204, './translator': 205 }
    ],
    205: [
      function(e, t, r) {
        var n = e('../core').util,
          ...
          u = function(e) {
            (e = e || {}), (this.attrValue =
              e.attrValue), (this.convertEmptyValues = Boolean(
              e.convertEmptyValues
            )), (this.wrapNumbers = Boolean(e.wrapNumbers));
          };
        (u.prototype.translateInput = function(e, t) {
          return (this.mode = 'input'), this.translate(e, t);
        }), (u.prototype.translateOutput = function(e, t) {
          return (this.mode = 'output'), this.translate(e, t);
        }), (u.prototype.translate = function(e, t) {
          var r = this;
          if (t && void 0 !== e) {
            if (t.shape === r.attrValue)
              return a[r.mode](e, {
                convertEmptyValues: r.convertEmptyValues,
                wrapNumbers: r.wrapNumbers
              });
            switch (t.type) {
              case 'structure':
                return r.translateStructure(e, t);
              case 'map':
                return r.translateMap(e, t);
              case 'list':
                return r.translateList(e, t);
              default:
                return r.translateScalar(e, t);
            }
          }
        }), (u.prototype.translateStructure = function(e, t) {
          var r = this;
          if (null != e) {
            var a = {};
            return n.each(e, function(e, n) {
              var u = t.members[e];
              if (u) {
                var i = r.translate(n, u);
                void 0 !== i && (a[e] = i);
              }
            }), a;
          }
        }), (u.prototype.translateList = function(e, t) {
          var r = this;
          if (null != e) {
            var a = [];
            return n.arrayEach(e, function(e) {
              var n = r.translate(e, t.member);
              void 0 === n ? a.push(null) : a.push(n);
            }), a;
          }
        }), (u.prototype.translateMap = function(e, t) {
          var r = this;
          if (null != e) {
            var a = {};
            return n.each(e, function(e, n) {
              var u = r.translate(n, t.value);
              a[e] = void 0 === u ? null : u;
            }), a;
          }
        }), (u.prototype.translateScalar = function(e, t) {
          return t.toType(e);
        }), (t.exports = u);
      },
      { '../core': 194, './converter': 201 }
    ],
    201: [
      function(e, t, r) {
        function n(e, t) {
          for (var r = { L: [] }, n = 0; n < e.length; n++)
            r.L.push(s.DynamoDB.Converter.input(e[n], t));
          return r;
        }
        function a(e, t) {
          return t ? new f(e) : Number(e);
        }
        function u(e, t) {
          var r = { M: {} };
          for (var n in e) {
            var a = s.DynamoDB.Converter.input(e[n], t);
            void 0 !== a && (r.M[n] = a);
          }
          return r;
        }
        function i(e, t) {
          t = t || {};
          var r = e.values;
          if (t.convertEmptyValues && ((r = o(e)), 0 === r.length))
            return s.DynamoDB.Converter.input(null);
          var n = {};
          switch (e.type) {
            case 'String':
              n.SS = r;
        ...
        function o(e) {
          var t = [];
          if ({ String: !0, Binary: !0, Number: !1 }[e.type]) {
            for (var r = 0; r < e.values.length; r++)
              0 !== e.values[r].length && t.push(e.values[r]);
            return t;
          }
          return e.values;
        }
        ...
        (s.DynamoDB.Converter = {
            ...
            return 'Object' === a
              ...
              : 'Array' === a
                ...
                : 'Set' === a
                  ? i(t, r)
                  : 'String' === a
                    ? 0 === t.length && r.convertEmptyValues
                      ? e(null)
                      : { S: t }
                    : 'Number' === a || 'NumberValue' === a
                      ? { N: t.toString() }
                      : 'Binary' === a
                        ? 0 === t.length && r.convertEmptyValues
                          ? e(null)
          ...
          marshall: function(e, t) {
            return s.DynamoDB.Converter.input(e, t).M;
          },
          output: function e(t, r) {
            ...
            for (var o in t) {
              ...
              if ('M' === o) {
                u = {};
                for (var p in s) u[p] = e(s[p], r);
                return u;
              }
              if ('L' === o) {
                for (n = [], i = 0; i < s.length; i++) n.push(e(s[i], r));
                return n;
              }
              if ('SS' === o) {
                for (n = [], i = 0; i < s.length; i++) n.push(s[i] + '');
                return new l(n);
              }
              if ('NS' === o) {
                for (n = [], i = 0; i < s.length; i++)
                  n.push(a(s[i], r.wrapNumbers));
                return new l(n);
              }
              if ('BS' === o) {
                for (n = [], i = 0; i < s.length; i++)
                  n.push(new c.Buffer(s[i]));
                return new l(n);
              }
              if ('S' === o) return s + '';
              if ('N' === o) return a(s, r.wrapNumbers);
              if ('B' === o) return new c.Buffer(s);
              if ('BOOL' === o) return 'true' === s || 'TRUE' === s || !0 === s;
              if ('NULL' === o) return null;
            }
          },
          unmarshall: function(e, t) {
            return s.DynamoDB.Converter.output({ M: e }, t);
          }
        }), (t.exports = s.DynamoDB.Converter);
      },
      { '../core': 194, './numberValue': 203, './set': 204, './types': 206 }
    ],
    204: [
      function(e, t, r) {
        var n = e('../core').util,
          ...
          i = n.inherit({
            constructor: function(e, t) {
              (t = t || {}), this.initialize(e, t.validate);
            },
            initialize: function(e, t) {
              var r = this;
              (r.values = [].concat(e)), r.detectType(), t && r.validate();
            },
            detectType: function() {
              if (((this.type = u[a(this.values[0])]), !this.type))
            ...
            validate: function() {
              for (
                var e = this, t = e.values.length, r = e.values, i = 0;
                i < t;
                i++
              )
                if (u[a(r[i])] !== e.type)
                  throw n.error(new Error(), {
                    code: 'InvalidType',
                    message: e.type + ' Set contains ' + a(r[i]) + ' value'
                  });
            }
          });
        t.exports = i;
          ...
          return null === e && 'object' == typeof e
            ...
            : void 0 !== e && a(e)
              ...
              : void 0 !== e && e.constructor
                ? u.typeName(e.constructor)
                : void 0 !== e && 'object' == typeof e ? 'Object' : 'undefined';
        }
        function a(e) {
          var t = [
            'Buffer',
          ...
          if (u.isNode()) {
            var r = u.stream.Stream;
            if (u.Buffer.isBuffer(e) || e instanceof r) return !0;
          }
          for (var n = 0; n < t.length; n++)
            if (void 0 !== e && e.constructor) {
              if (u.isType(e, t[n])) return !0;
              if (u.typeName(e.constructor) === t[n]) return !0;
            }
          return !1;
        }
        var u = e('../core').util;
        t.exports = { typeOf: n, isBinary: a };
      },
      { '../core': 194 }
    ],
    203: [
...
AWS.apiLoader.services.dynamodb['2012-08-10'] = {
  ...
  operations: {
    ...
    ListTagsOfResource: {
      ...
      output: {
        type: 'structure',
        members: { Tags: { shape: 'S3a' }, NextToken: {} }
      }
    },
    PutItem: {
      input: {
    ...
    Query: {
      input: {
        ...
        members: {
          ...
          Limit: { type: 'integer' },
          ConsistentRead: { type: 'boolean' },
          KeyConditions: { type: 'map', key: {}, value: { shape: 'S3k' } },
          QueryFilter: { shape: 'S3l' },
          ConditionalOperator: {},
    ...
    TagResource: {
      input: {
        ...
        members: { ResourceArn: {}, Tags: { shape: 'S3a' } }
      }
    },
    UntagResource: {
      input: {
    ...
    UpdateTimeToLive: {
      input: {
        ...
        members: { TableName: {}, TimeToLiveSpecification: { shape: 'S4a' } }
      },
      output: {
        type: 'structure',
        members: { TimeToLiveSpecification: { shape: 'S4a' } }
      }
    }
  },
  shapes: {
    ...
    S3l: { type: 'map', key: {}, value: { shape: 'S3k' } },
    S4a: {
      type: 'structure',
...
(AWS.apiLoader.services.sts = {}), (AWS.STS = AWS.Service.defineService('sts', [
  '2011-06-15'
